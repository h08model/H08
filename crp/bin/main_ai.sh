...
#by   2022/03,    ai,      NIES: modified for added function
############################################################
...
PROG=main_ai             # Program: No need to change!
############################################################
...
############################################################
 ...
 SWDOWN=../../met/dat/SWdown__/${PRJMET}${RUNMET}${SUF}DY
   CAR=../../met/dat/Co2_____/${PRJMET}${RUNMET}${SUF}DY
   VPD=../../met/dat/Vpd_____/${PRJMET}${RUNMET}${SUF}DY
POTEVAP=../../lnd/out/PotEvap_/${PRJ}LR__${SUF}DY
#POTEVAP=../../lnd/out/PotEvap_/WFDENR__${SUF}DY  # see above note
...
LOGFILE=${DIRLOG}/${PRJ}${RUN}${YEAR}${DATE}.log
############################################################
...
SETFILE=${DIRSET}/${PRJ}${RUN}${YEAR}${DATE}.set
############################################################
...
if [ $JOB = "5" ]; then
     FER=../../map/dat/fer_____/lai_cal7_${CRPNAM}${SUF}
elif [ $JOB = "12" ]; then
     FER=../../map/dat/fer_____/lai_cal7_${CRPNAM}${SUF}
elif [ $JOB = "15" ]; then
     FER=../../map/dat/fer_____/lai_cal7_${CRPNAM}${SUF}
     ...
     FER=../../map/dat/fer_____/lai_assumed${SUF}
fi
#
  if [ $JOB = "2nd" ]; then
#
