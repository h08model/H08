...
d           if(i0l.eq.i0ldbg)then
d             write(*,*) 'calc_humact: r1rivsto [m3] ',
d    $             r1rivsto(i0ldbg)/1000.0
d           end if
c river process - rivout
            if (r1paramc(i0l).ne.p0mis) then
              r1rivout(i0l)
     $             = r1rivinf(i0l)
...
c F18 start
              if(r1targetmax(i0l).eq.0.0.and.
     $           r1targetmin(i0l).eq.0.0)then
                 r1targetmax(i0l)=1.0
                 r1targetmin(i0l)=0.0
              end if
              if(r1damsto(i0l).gt.r1targetmax(i0l)*r1damcap(i0l))then
                r1damout(i0l)=r1damout(i0l)
     $        +(r1damsto(i0l)-r1targetmax(i0l)*r1damcap(i0l))/i0secint
                r1damsto(i0l)=r1targetmax(i0l)*r1damcap(i0l)
         else if(r1damsto(i0l).lt.r1targetmin(i0l)*r1damcap(i0l))then
                r1damout(i0l)=r1damout(i0l)
     $        +(r1damsto(i0l)-r1targetmin(i0l)*r1damcap(i0l))/i0secint
                r1damsto(i0l)=r1targetmin(i0l)*r1damcap(i0l)
              end if
c F18 end
...
c supply from recycled water
      if(c0optrcl.eq.'yes')then
        call calc_supdes(n0l,r1demdoms,r1supdoms,i1rclpot,
     $       r1supdomrcl)
        call calc_supdes(n0l,r1deminds,r1supinds,i1rclpot,
     $       r1supindrcl)
      end if
c supply from NNBW (Surface Water)
      if(c0optnnb.eq.'yes')then
