...
c
     ...
     $   c0idx.ne.'MY'.and.c0idx.ne.'MM'.and.c0idx.ne.'MD')then
        write(*,*) 'wrte_ascii4: c0idx ',c0idx,' not supported.'
        stop
      end if
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c Write
        ...
        do i0year=i0yearmin,i0yearmax
         if(c0idx.eq.'YR'.or.c0idx.eq.'MY')then
          ...
          do i0mon=i0monmin,i0monmax
            if(c0idx.eq.'DY'.or.c0idx.eq.'MD')then
              i0daymin=1
            ...
            do i0day=i0daymin,i0daymax
              if(i0year.eq.0)then
                ...
                r0tmp=r3out(i0year-n0yearmin+1,i0mon,i0day)
                if(r0tmp.eq.p0mis)then
                  r0tmp=-9999.0
                end if
                write(n0of,*) i0year,i0mon,i0day,r0tmp
