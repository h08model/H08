...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine conv_rhtoqa(
     $     n0l,
     $     r1rh,r1psurf,r1tair,
     $     r1qair)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
cto   convert relative humidty (RH) to specific humidity (Qair)
...
c in
      ...
      real              r1psurf(n0l)    !! surface pressure
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
     ...
     $     r1rh(i0l).ne.p0mis.and.r1tair(i0l).ne.0.0.and.
     ...
     $           (265.3+r1tair(i0l)-p0icepnt))*100.0 !! hPa->Pa
          ...
          r1e(i0l)=r1esat(i0l)*r1rh(i0l)
          r1qair(i0l)=0.622*r1e(i0l)/r1psurf(i0l)
        else
          r1qair(i0l)=p0mis
        end if
      end do
