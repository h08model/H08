...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      program main_fix
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
cto   run land surface model by fixing soilmoisture
...
c out (8: to fix soil moisture)
      real              r1add(n0l)
      real              r2add(n0l,0:n0t)
      character*128     c0add
c local
...
c
              do i0l=1,n0l
                if(r1lndara(i0l).ne.0.0.and.r1lndara(i0l).ne.p0mis)then
...
c
              ...
              do i0l=1,n0l
                if(r1lndara(i0l).ne.0.0.and.r1lndara(i0l).ne.p0mis)then
                  if(r1soilmoist_pr(i0l).lt.r1soilmoisttarget(i0l))then
                    r1add(i0l)
     $                   =(r1soilmoisttarget(i0l)-r1soilmoist_pr(i0l))
     $                   *r1lndara(i0l)/real(i0secint)
                  end if
                end if
              end do
c
...
c out 8
     ...
     $             r1add,         r2add,       c0add,
     $             i0year,i0mon,i0day,i0sec,i0secint,c0opt)    
d             write(*,*) 'main: r1add:      ',r1add(i0ldbg)
c
              do i0l=1,n0l
