PROGRAM main
  ...
  real, dimension(1000) :: xlon_mat, ylat_mat, rain_mat
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
!  file1='rain_'//zy//'_'//zm//'_'//zd//'.dat'
   file1='AMeDAS2C03_'//zy//'_'//zm//'_'//zd//'.txt'
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  do while (.true.)
     read(10, *, err=100, end=110) zstation, xlon, ylat, irain
     istation=istation+1

     xlon_mat(istation)=xlon     
     ylat_mat(istation)=ylat
     rain_mat(istation)=real(irain)/86400
!write(6, *) xlon_mat(istation), ylat_mat(istation), rain_mat(istation)
100  continue
  end do
110 continue
...
!           write(6, *) istation, distance
           ...
           rain_sum=rain_sum+rain_mat(istation)/(distance**2)
           weight_sum=weight_sum+1.0/(distance**2)

        end do

        rain_ave=rain_sum/weight_sum
