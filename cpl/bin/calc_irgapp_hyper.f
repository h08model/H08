...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     $     i2crptypp,i2crptypf,    r1soildepth, r1w_fieldcap,r1w_wilt,
     $     r1lndara,    r1arafrc,
...
c in (map)     
cnew start
c      integer           i2crptyp(n0l,n0c)  !! crop type
      integer           i2crptypp(n0l,n0c)  !! crop type
      integer           i2crptypf(n0l,n0c)  !! crop type
cnew end
...
c in (flux)
cnew start
c      integer           i2flgcul(n0l,n0c)  !! cultivation flag
c      integer           i2flgirg(n0l,n0c)  !! irrigation flag
c      real              r2target(n0l,n0c)  !! target SoilMoisture
      integer           i2flgculp(n0l,n0c)  !! cultivation flag
      integer           i2flgirgp(n0l,n0c)  !! irrigation flag
      real              r2targetp(n0l,n0c)  !! target SoilMoisture
      integer           i2flgculf(n0l,n0c)  !! cultivation flag
      integer           i2flgirgf(n0l,n0c)  !! irrigation flag
      real              r2targetf(n0l,n0c)  !! target SoilMoisture
cnew end
...
c
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c      if(c0optlnduse.ne.'dci'.and.c0optlnduse.ne.'sci'.and.
c     $   c0optlnduse.ne.'scr'.and.c0optlnduse.ne.'non')then
      if(c0optlnduse.ne.'dci'.and.c0optlnduse.ne.'sci'.and.
     $   c0optlnduse.ne.'dpi'.and.c0optlnduse.ne.'spi'.and.
...
c
      if(c0optlnduse.eq.'dci')then
        do i0l=1,n0l
          ...
          else if(i2flgculf(i0l,2).eq.1)then
            i1crptyp(i0l)=i2crptypf(i0l,2)
          end if
        end do
        do i0l=1,n0l
          if(i2flgirgf(i0l,1).eq.1)then
            i1flgirg(i0l)=i2flgirgf(i0l,1)
            r1target(i0l)=r2targetf(i0l,1)
          else if(i2flgirgf(i0l,2).eq.1)then
            i1flgirg(i0l)=i2flgirgf(i0l,2)
            r1target(i0l)=r2targetf(i0l,2)
          end if
        end do
        do i0l=1,n0l
      ...
      else if(c0optlnduse.eq.'dpi')then
        do i0l=1,n0l
        ...
        do i0l=1,n0l
          if(i2flgirgp(i0l,1).eq.1)then
            i1flgirg(i0l)=i2flgirgp(i0l,1)
            r1target(i0l)=r2targetp(i0l,1)
          else if(i2flgirgp(i0l,2).eq.1)then
            i1flgirg(i0l)=i2flgirgp(i0l,2)
            r1target(i0l)=r2targetp(i0l,2)
          end if
        end do
        do i0l=1,n0l
          if(r1arafrc(i0l).ne.p0mis)then
      ...
      else if(c0optlnduse.eq.'spi')then
        do i0l=1,n0l
          if(i2flgculp(i0l,1).eq.1)then
            i1crptyp(i0l)=i2crptypp(i0l,1)
          end if
        ...
        r1target=0.0
        r1irgara=0.0
      else if(c0optlnduse.eq.'spr')then
        do i0l=1,n0l
          if(i2flgculf(i0l,1).eq.1)then
            i1crptyp(i0l)=i2crptypp(i0l,1)
          end if
...
d      write(*,*) 'calc_irgapp; |-r1arafrc   ',r1arafrc(i0ldbg)
...
c
        ...
        else if(c0optlnduse.eq.'dci')then
          do i0l=1,n0l
            r1add(i0l)=max(min(r1demagr(i0l),r1supagr(i0l)),0.0)
          end do
          do i0l=1,n0l
