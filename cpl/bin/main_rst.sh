...
PRJ="${1}"		            # Project name
RUN="${2}"                # Run name
YEARMIN="${3}"            # Start year
YEARMAX="${4}"            # End year
SECINT=86400              # interval (Set 86400 for restart)
LDBG=1                 # debugging point (any integer number not larger than n0l)
# 
# PRJMET=wfde           # Project name of meteorological data
PRJMET="${5}"           # Project name of meteorological data
RUNMET="${6}"           # Run     name of meteorological data
PRJLR__=WFDE            # Project name of LR__ simulation (Manual Ch.8,9; Land surface & River module)
RUNLR__=LR__            # Run     name of LR__ simulation (Manual Ch.8,9; Land surface & River module)
PRJ__C_=WFDE            # Project name of __C_ simulation (Manual Ch.10; Crop growth module)
RUN__C_=__C_            # Run     name of __C_ simulation (Manual Ch.10; Crop growth module)
PRJN_C_=WFDE            # Project name of N_C_ simulation (Manual Ch.13; N_C_ experiment of Coupled simulation)
RUNN_C_=N_C_            # Run     name of N_C_ simulation (Manual Ch.13; N_C_ experiment of Coupled simulation)
############################################################
# Expert settings (Do not edit here unless you are an expert)
############################################################
SPNFLG="${7}"           # spinup flag (1 for skip spinup)
...
############################################################
RSTBGNFLG="${8}"          # restart start flag (1 for activate restart)
RSTENDFLG="${9}"          # restart end flag (1 for activate restart)
YEARRSTBGN="${10}"         # year to start the restart calculation
MONRSTBGN="${11}"          # month
DAYRSTBGN="${12}"         # day
YEARRSTEND="${13}"        # year to temporaliy end the calculation
MONRSTEND="${14}"         # month
DAYRSTEND="${15}"         # day
############################################################
...
############################################################
# Output directory Restart (Do not edit here unless you are an expert)
############################################################
      DIRSOILMOISTRST0=../../rst/out/tmp/SoilMois
       DIRSOILTEMPRST0=../../rst/out/tmp/SoilTemp
            DIRSWERST0=../../rst/out/tmp/SWE_____
       DIRAVGSURFTRST0=../../rst/out/tmp/AvgSurfT
             DIRGWRST0=../../rst/out/tmp/GW______
      DIRSOILMOISTRST1=../../rst/out/tmp/SoilMoi1
       DIRSOILTEMPRST1=../../rst/out/tmp/SoilTem1
            DIRSWERST1=../../rst/out/tmp/SWE____1
       DIRAVGSURFTRST1=../../rst/out/tmp/AvgSurf1
             DIRGWRST1=../../rst/out/tmp/GW_____1
      DIRSOILMOISTRST2=../../rst/out/tmp/SoilMoi2
       DIRSOILTEMPRST2=../../rst/out/tmp/SoilTem2
            DIRSWERST2=../../rst/out/tmp/SWE____2
       DIRAVGSURFTRST2=../../rst/out/tmp/AvgSurf2
             DIRGWRST2=../../rst/out/tmp/GW_____2
      DIRSOILMOISTRST3=../../rst/out/tmp/SoilMoi3
       DIRSOILTEMPRST3=../../rst/out/tmp/SoilTem3
            DIRSWERST3=../../rst/out/tmp/SWE____3
       DIRAVGSURFTRST3=../../rst/out/tmp/AvgSurf3
             DIRGWRST3=../../rst/out/tmp/GW_____3
      DIRSOILMOISTRST4=../../rst/out/tmp/SoilMoi4
       DIRSOILTEMPRST4=../../rst/out/tmp/SoilTem4
            DIRSWERST4=../../rst/out/tmp/SWE____4
       DIRAVGSURFTRST4=../../rst/out/tmp/AvgSurf4
             DIRGWRST4=../../rst/out/tmp/GW_____4

          DIRRIVINFRST=../../rst/out/tmp/riv_inf_
          DIRRIVOUTRST=../../rst/out/tmp/riv_out_
          DIRRIVSTORST=../../rst/out/tmp/riv_sto_
        DIRRIVSTOPRRST=../../rst/out/tmp/riv_stPR

         DIRCRPDAYRST0=../../rst/out/tmp/crp_day_
         DIRCRPDAYRST1=../../rst/out/tmp/crp_day1
         DIRCRPDAYRST2=../../rst/out/tmp/crp_day2
         DIRCRPDAYRST3=../../rst/out/tmp/crp_day3
         DIRCRPDAYRST4=../../rst/out/tmp/crp_day4

       DIRHEATUNITRST0=../../rst/out/tmp/HeatUnit
            DIRSWURST0=../../rst/out/tmp/SWU_____
            DIRSWPRST0=../../rst/out/tmp/SWP_____
          DIRREGFWRST0=../../rst/out/tmp/Regf_W__
          DIRREGFLRST0=../../rst/out/tmp/Regf_L__
          DIRREGFHRST0=../../rst/out/tmp/Regf_H__
          DIRREGFNRST0=../../rst/out/tmp/Regf_N__
          DIRREGFPRST0=../../rst/out/tmp/Regf_P__
             DIRBTRST0=../../rst/out/tmp/Biomas__
            DIRRSDRST0=../../rst/out/tmp/Residual
           DIROUTBRST0=../../rst/out/tmp/OutOfSys
            DIRCWDRST0=../../rst/out/tmp/CWD_____
            DIRCWSRST0=../../rst/out/tmp/CWS_____
         DIRCWSGRNRST0=../../rst/out/tmp/CWS_Grn_
         DIRCWSBLURST0=../../rst/out/tmp/CWS_Blu_
       DIRHEATUNITRST1=../../rst/out/tmp/HeatUni1
            DIRSWURST1=../../rst/out/tmp/SWU____1
            DIRSWPRST1=../../rst/out/tmp/SWP____1
          DIRREGFWRST1=../../rst/out/tmp/Regf_W_1
          DIRREGFLRST1=../../rst/out/tmp/Regf_L_1
          DIRREGFHRST1=../../rst/out/tmp/Regf_H_1
          DIRREGFNRST1=../../rst/out/tmp/Regf_N_1
          DIRREGFPRST1=../../rst/out/tmp/Regf_P_1
             DIRBTRST1=../../rst/out/tmp/Biomas_1
            DIRRSDRST1=../../rst/out/tmp/Residua1
           DIROUTBRST1=../../rst/out/tmp/OutOfSy1
            DIRCWDRST1=../../rst/out/tmp/CWD____1
            DIRCWSRST1=../../rst/out/tmp/CWS____1
         DIRCWSGRNRST1=../../rst/out/tmp/CWS_Grn1
         DIRCWSBLURST1=../../rst/out/tmp/CWS_Blu1
       DIRHEATUNITRST2=../../rst/out/tmp/HeatUni2
            DIRSWURST2=../../rst/out/tmp/SWU____2
            DIRSWPRST2=../../rst/out/tmp/SWP____2
          DIRREGFWRST2=../../rst/out/tmp/Regf_W_2
          DIRREGFLRST2=../../rst/out/tmp/Regf_L_2
          DIRREGFHRST2=../../rst/out/tmp/Regf_H_2
          DIRREGFNRST2=../../rst/out/tmp/Regf_N_2
          DIRREGFPRST2=../../rst/out/tmp/Regf_P_2
             DIRBTRST2=../../rst/out/tmp/Biomas_2
            DIRRSDRST2=../../rst/out/tmp/Residua2
           DIROUTBRST2=../../rst/out/tmp/OutOfSy2
            DIRCWDRST2=../../rst/out/tmp/CWD____2
            DIRCWSRST2=../../rst/out/tmp/CWS____2
         DIRCWSGRNRST2=../../rst/out/tmp/CWS_Grn2
         DIRCWSBLURST2=../../rst/out/tmp/CWS_Blu2
       DIRHEATUNITRST3=../../rst/out/tmp/HeatUni3
            DIRSWURST3=../../rst/out/tmp/SWU____3
            DIRSWPRST3=../../rst/out/tmp/SWP____3
          DIRREGFWRST3=../../rst/out/tmp/Regf_W_3
          DIRREGFLRST3=../../rst/out/tmp/Regf_L_3
          DIRREGFHRST3=../../rst/out/tmp/Regf_H_3
          DIRREGFNRST3=../../rst/out/tmp/Regf_N_3
          DIRREGFPRST3=../../rst/out/tmp/Regf_P_3
             DIRBTRST3=../../rst/out/tmp/Biomas_3
            DIRRSDRST3=../../rst/out/tmp/Residua3
           DIROUTBRST3=../../rst/out/tmp/OutOfSy3
            DIRCWDRST3=../../rst/out/tmp/CWD____3
            DIRCWSRST3=../../rst/out/tmp/CWS____3
         DIRCWSGRNRST3=../../rst/out/tmp/CWS_Grn3
         DIRCWSBLURST3=../../rst/out/tmp/CWS_Blu3
       DIRHEATUNITRST4=../../rst/out/tmp/HeatUni4
            DIRSWURST4=../../rst/out/tmp/SWU____4
            DIRSWPRST4=../../rst/out/tmp/SWP____4
          DIRREGFWRST4=../../rst/out/tmp/Regf_W_4
          DIRREGFLRST4=../../rst/out/tmp/Regf_L_4
          DIRREGFHRST4=../../rst/out/tmp/Regf_H_4
          DIRREGFNRST4=../../rst/out/tmp/Regf_N_4
          DIRREGFPRST4=../../rst/out/tmp/Regf_P_4
             DIRBTRST4=../../rst/out/tmp/Biomas_4
            DIRRSDRST4=../../rst/out/tmp/Residua4
           DIROUTBRST4=../../rst/out/tmp/OutOfSy4
            DIRCWDRST4=../../rst/out/tmp/CWD____4
            DIRCWSRST4=../../rst/out/tmp/CWS____4
         DIRCWSGRNRST4=../../rst/out/tmp/CWS_Grn4
         DIRCWSBLURST4=../../rst/out/tmp/CWS_Blu4

         DIRFLGCULRST1=../../rst/out/tmp/Flg_Cul1
         DIRFLGCULRST2=../../rst/out/tmp/Flg_Cul2
         DIRFLGIRGRST1=../../rst/out/tmp/Flg_Irg1
         DIRFLGIRGRST2=../../rst/out/tmp/Flg_Irg2
         DIRTARGETRST1=../../rst/out/tmp/target_1
         DIRTARGETRST2=../../rst/out/tmp/target_2

          DIRSUPAGRRST=../../rst/out/tmp/SupAgr__

          DIRMSRSTORST=../../rst/out/tmp/msr_sto_
          DIRDAMOUTRST=../../rst/out/tmp/dam_out_
          DIRDAMSTORST=../../rst/out/tmp/dam_sto_
            DIRKRLSRST=../../rst/out/tmp/dam_krls

    DIRFRCSUPAGRRIVRST=../../rst/out/tmp/FrcSaRIV
    DIRFRCSUPAGRRGWRST=../../rst/out/tmp/FrcSaRGW
    DIRFRCSUPAGRMSRRST=../../rst/out/tmp/FrcSaMSR
    DIRFRCSUPAGRNNBRST=../../rst/out/tmp/FrcSaNNB
DIRFRCSOILMOISTGRNRST0=../../rst/out/tmp/FrcSmGRN
DIRFRCSOILMOISTRIVRST0=../../rst/out/tmp/FrcSmRIV
DIRFRCSOILMOISTMSRRST0=../../rst/out/tmp/FrcSmMSR
DIRFRCSOILMOISTNNBRST0=../../rst/out/tmp/FrcSmNNB
DIRFRCSOILMOISTGRNRST1=../../rst/out/tmp/FrcSmGR1
DIRFRCSOILMOISTRIVRST1=../../rst/out/tmp/FrcSmRI1
DIRFRCSOILMOISTMSRRST1=../../rst/out/tmp/FrcSmMS1
DIRFRCSOILMOISTNNBRST1=../../rst/out/tmp/FrcSmNN1
DIRFRCSOILMOISTGRNRST2=../../rst/out/tmp/FrcSmGR2
DIRFRCSOILMOISTRIVRST2=../../rst/out/tmp/FrcSmRI2
DIRFRCSOILMOISTMSRRST2=../../rst/out/tmp/FrcSmMS2
DIRFRCSOILMOISTNNBRST2=../../rst/out/tmp/FrcSmNN2
DIRFRCSOILMOISTGRNRST3=../../rst/out/tmp/FrcSmGR3
DIRFRCSOILMOISTRIVRST3=../../rst/out/tmp/FrcSmRI3
DIRFRCSOILMOISTMSRRST3=../../rst/out/tmp/FrcSmMS3
DIRFRCSOILMOISTNNBRST3=../../rst/out/tmp/FrcSmNN3
DIRFRCSOILMOISTGRNRST4=../../rst/out/tmp/FrcSmGR4
DIRFRCSOILMOISTRIVRST4=../../rst/out/tmp/FrcSmRI4
DIRFRCSOILMOISTMSRRST4=../../rst/out/tmp/FrcSmMS4
DIRFRCSOILMOISTNNBRST4=../../rst/out/tmp/FrcSmNN4

      DIRYLDOUT1STRST1=../../rst/out/tmp/yld_1st1
      DIRCWDOUT1STRST1=../../rst/out/tmp/cwd_1st1
      DIRCWSOUT1STRST1=../../rst/out/tmp/cws_1st1
    DIRREGFDOUT1STRST1=../../rst/out/tmp/reg_1st1
   DIRHVSDOYOUT1STRST1=../../rst/out/tmp/hvs_1st1
   DIRCRPDAYOUT1STRST1=../../rst/out/tmp/crp_1st1
      DIRYLDOUT2NDRST1=../../rst/out/tmp/yld_2nd1
      DIRCWDOUT2NDRST1=../../rst/out/tmp/cwd_2nd1
      DIRCWSOUT2NDRST1=../../rst/out/tmp/cws_2nd1
    DIRREGFDOUT2NDRST1=../../rst/out/tmp/reg_2nd1
   DIRHVSDOYOUT2NDRST1=../../rst/out/tmp/hvs_2nd1
   DIRCRPDAYOUT2NDRST1=../../rst/out/tmp/crp_2nd1
      DIRYLDOUT1STRST2=../../rst/out/tmp/yld_1st2
      DIRCWDOUT1STRST2=../../rst/out/tmp/cwd_1st2
      DIRCWSOUT1STRST2=../../rst/out/tmp/cws_1st2
    DIRREGFDOUT1STRST2=../../rst/out/tmp/reg_1st2
   DIRHVSDOYOUT1STRST2=../../rst/out/tmp/hvs_1st2
   DIRCRPDAYOUT1STRST2=../../rst/out/tmp/crp_1st2
      DIRYLDOUT2NDRST2=../../rst/out/tmp/yld_2nd2
      DIRCWDOUT2NDRST2=../../rst/out/tmp/cwd_2nd2
      DIRCWSOUT2NDRST2=../../rst/out/tmp/cws_2nd2
    DIRREGFDOUT2NDRST2=../../rst/out/tmp/reg_2nd2
   DIRHVSDOYOUT2NDRST2=../../rst/out/tmp/hvs_2nd2
   DIRCRPDAYOUT2NDRST2=../../rst/out/tmp/crp_2nd2
      DIRYLDOUT1STRST3=../../rst/out/tmp/yld_1st3
      DIRCWDOUT1STRST3=../../rst/out/tmp/cwd_1st3
      DIRCWSOUT1STRST3=../../rst/out/tmp/cws_1st3
    DIRREGFDOUT1STRST3=../../rst/out/tmp/reg_1st3
   DIRHVSDOYOUT1STRST3=../../rst/out/tmp/hvs_1st3
   DIRCRPDAYOUT1STRST3=../../rst/out/tmp/crp_1st3
      DIRYLDOUT2NDRST3=../../rst/out/tmp/yld_2nd3
      DIRCWDOUT2NDRST3=../../rst/out/tmp/cwd_2nd3
      DIRCWSOUT2NDRST3=../../rst/out/tmp/cws_2nd3
    DIRREGFDOUT2NDRST3=../../rst/out/tmp/reg_2nd3
   DIRHVSDOYOUT2NDRST3=../../rst/out/tmp/hvs_2nd3
   DIRCRPDAYOUT2NDRST3=../../rst/out/tmp/crp_2nd3
      DIRYLDOUT1STRST4=../../rst/out/tmp/yld_1st4
      DIRCWDOUT1STRST4=../../rst/out/tmp/cwd_1st4
      DIRCWSOUT1STRST4=../../rst/out/tmp/cws_1st4
    DIRREGFDOUT1STRST4=../../rst/out/tmp/reg_1st4
   DIRHVSDOYOUT1STRST4=../../rst/out/tmp/hvs_1st4
   DIRCRPDAYOUT1STRST4=../../rst/out/tmp/crp_1st4
      DIRYLDOUT2NDRST4=../../rst/out/tmp/yld_2nd4
      DIRCWDOUT2NDRST4=../../rst/out/tmp/cwd_2nd4
      DIRCWSOUT2NDRST4=../../rst/out/tmp/cws_2nd4
    DIRREGFDOUT2NDRST4=../../rst/out/tmp/reg_2nd4
   DIRHVSDOYOUT2NDRST4=../../rst/out/tmp/hvs_2nd4
   DIRCRPDAYOUT2NDRST4=../../rst/out/tmp/crp_2nd4
   DIRCWSOUT1STGRNRST1=../../rst/out/tmp/cwsg1st1
   DIRCWSOUT2NDGRNRST1=../../rst/out/tmp/cwsg2nd1
   DIRCWSOUT1STBLURST1=../../rst/out/tmp/cwsb1st1
   DIRCWSOUT2NDBLURST1=../../rst/out/tmp/cwsb2nd1
   DIRCWSOUT1STGRNRST2=../../rst/out/tmp/cwsg1st2
   DIRCWSOUT2NDGRNRST2=../../rst/out/tmp/cwsg2nd2
   DIRCWSOUT1STBLURST2=../../rst/out/tmp/cwsb1st2
   DIRCWSOUT2NDBLURST2=../../rst/out/tmp/cwsb2nd2
   DIRCWSOUT1STGRNRST3=../../rst/out/tmp/cwsg1st3
   DIRCWSOUT2NDGRNRST3=../../rst/out/tmp/cwsg2nd3
   DIRCWSOUT1STBLURST3=../../rst/out/tmp/cwsb1st3
   DIRCWSOUT2NDBLURST3=../../rst/out/tmp/cwsb2nd3
   DIRCWSOUT1STGRNRST4=../../rst/out/tmp/cwsg1st4
   DIRCWSOUT2NDGRNRST4=../../rst/out/tmp/cwsg2nd4
   DIRCWSOUT1STBLURST4=../../rst/out/tmp/cwsb1st4
   DIRCWSOUT2NDBLURST4=../../rst/out/tmp/cwsb2nd4

          DIRDAMDEMRST=../../rst/out/tmp/dam_dem_
          DIRMSROUTRST=../../rst/out/tmp/msr_out_
          DIRSUPINDRST=../../rst/out/tmp/SupInd__
          DIRSUPDOMRST=../../rst/out/tmp/SupDom__
          DIRLOSAGRRST=../../rst/out/tmp/LosAgr__
          DIRRTFAGRRST=../../rst/out/tmp/RtFAgr__
          DIRRTFINDRST=../../rst/out/tmp/RtFInd__
          DIRRTFDOMRST=../../rst/out/tmp/RtFDom__
           DIREVAPRST0=../../rst/out/tmp/Evap____
             DIRQSRST0=../../rst/out/tmp/Qs______
            DIRQSBRST0=../../rst/out/tmp/Qsb_____
           DIRQTOTRST0=../../rst/out/tmp/Qtot____
            DIRQBFRST0=../../rst/out/tmp/Qbf_____
            DIRQRCRST0=../../rst/out/tmp/Qrc_____
           DIREVAPRST1=../../rst/out/tmp/Evap___1
             DIRQSRST1=../../rst/out/tmp/Qs_____1
            DIRQSBRST1=../../rst/out/tmp/Qsb____1
           DIRQTOTRST1=../../rst/out/tmp/Qtot___1
            DIRQBFRST1=../../rst/out/tmp/Qbf____1
            DIRQRCRST1=../../rst/out/tmp/Qrc____1
           DIREVAPRST2=../../rst/out/tmp/Evap___2
             DIRQSRST2=../../rst/out/tmp/Qs_____2
            DIRQSBRST2=../../rst/out/tmp/Qsb____2
           DIRQTOTRST2=../../rst/out/tmp/Qtot___2
            DIRQBFRST2=../../rst/out/tmp/Qbf____2
            DIRQRCRST2=../../rst/out/tmp/Qrc____2
           DIREVAPRST3=../../rst/out/tmp/Evap___3
             DIRQSRST3=../../rst/out/tmp/Qs_____3
            DIRQSBRST3=../../rst/out/tmp/Qsb____3
           DIRQTOTRST3=../../rst/out/tmp/Qtot___3
            DIRQBFRST3=../../rst/out/tmp/Qbf____3
            DIRQRCRST3=../../rst/out/tmp/Qrc____3
           DIREVAPRST4=../../rst/out/tmp/Evap___4
             DIRQSRST4=../../rst/out/tmp/Qs_____4
            DIRQSBRST4=../../rst/out/tmp/Qsb____4
           DIRQTOTRST4=../../rst/out/tmp/Qtot___4
            DIRQBFRST4=../../rst/out/tmp/Qbf____4
            DIRQRCRST4=../../rst/out/tmp/Qrc____4
############################################################
...
# Variables required to keep consistency
     ...
     SOILMOISTWRST4=${DIRSOILMOISTWRST4}/${PRJ}${RUN}${SUF}DY
       ...
       RIVSTOPRWRST=${DIRRIVSTOPRWRST}/${PRJ}${RUN}${SUF}DY        # River storage (write simulated data)
         ...
         CRPDAYRST3=${DIRCRPDAYRST3}/${PRJ}${RUN}${SUF}DY
         CRPDAYRST4=${DIRCRPDAYRST4}/${PRJ}${RUN}${SUF}DY
       HEATUNITRST0=${DIRHEATUNITRST0}/${PRJ}${RUN}${SUF}DY        # Heat unit
            SWURST0=${DIRSWURST0}/${PRJ}${RUN}${SUF}DY             # Plant transpiration in latter half
            SWPRST0=${DIRSWPRST0}/${PRJ}${RUN}${SUF}DY             # Potential transpiration in latter half
          REGFWRST0=${DIRREGFWRST0}/${PRJ}${RUN}${SUF}DY           # Regulation factor in water
          REGFLRST0=${DIRREGFLRST0}/${PRJ}${RUN}${SUF}DY           # Regulation factor in low temperature
          REGFHRST0=${DIRREGFHRST0}/${PRJ}${RUN}${SUF}DY           # Regulation factor in high temperature
          REGFNRST0=${DIRREGFNRST0}/${PRJ}${RUN}${SUF}DY           # Regulation factor in nitrogen
          REGFPRST0=${DIRREGFPRST0}/${PRJ}${RUN}${SUF}DY           # Regulation factor in phosphorus
             BTRST0=${DIRBTRST0}/${PRJ}${RUN}${SUF}DY              # Total biomass
            RSDRST0=${DIRRSDRST0}/${PRJ}${RUN}${SUF}DY             # Residual 
           OUTBRST0=${DIROUTBRST0}/${PRJ}${RUN}${SUF}DY            # Out fo system
            CWDRST0=${DIRCWDRST0}/${PRJ}${RUN}${SUF}DY             # Crop water demand
            CWSRST0=${DIRCWSRST0}/${PRJ}${RUN}${SUF}DY             # Crop water supply
         CWSGRNRST0=${DIRCWSGRNRST0}/${PRJ}${RUN}${SUF}DY          # Crop water supply from green water
         CWSBLURST0=${DIRCWSBLURST0}/${PRJ}${RUN}${SUF}DY          # Crop water supply from blue water
       HEATUNITRST1=${DIRHEATUNITRST1}/${PRJ}${RUN}${SUF}DY
            SWURST1=${DIRSWURST1}/${PRJ}${RUN}${SUF}DY
            SWPRST1=${DIRSWPRST1}/${PRJ}${RUN}${SUF}DY
          REGFWRST1=${DIRREGFWRST1}/${PRJ}${RUN}${SUF}DY
          REGFLRST1=${DIRREGFLRST1}/${PRJ}${RUN}${SUF}DY
          REGFHRST1=${DIRREGFHRST1}/${PRJ}${RUN}${SUF}DY
          REGFNRST1=${DIRREGFNRST1}/${PRJ}${RUN}${SUF}DY
          REGFPRST1=${DIRREGFPRST1}/${PRJ}${RUN}${SUF}DY
             BTRST1=${DIRBTRST1}/${PRJ}${RUN}${SUF}DY
            RSDRST1=${DIRRSDRST1}/${PRJ}${RUN}${SUF}DY
           OUTBRST1=${DIROUTBRST1}/${PRJ}${RUN}${SUF}DY
            CWDRST1=${DIRCWDRST1}/${PRJ}${RUN}${SUF}DY
            CWSRST1=${DIRCWSRST1}/${PRJ}${RUN}${SUF}DY
         CWSGRNRST1=${DIRCWSGRNRST1}/${PRJ}${RUN}${SUF}DY
         CWSBLURST1=${DIRCWSBLURST1}/${PRJ}${RUN}${SUF}DY
       HEATUNITRST2=${DIRHEATUNITRST2}/${PRJ}${RUN}${SUF}DY
            SWURST2=${DIRSWURST2}/${PRJ}${RUN}${SUF}DY
            SWPRST2=${DIRSWPRST2}/${PRJ}${RUN}${SUF}DY
          REGFWRST2=${DIRREGFWRST2}/${PRJ}${RUN}${SUF}DY
          REGFLRST2=${DIRREGFLRST2}/${PRJ}${RUN}${SUF}DY
          REGFHRST2=${DIRREGFHRST2}/${PRJ}${RUN}${SUF}DY
          REGFNRST2=${DIRREGFNRST2}/${PRJ}${RUN}${SUF}DY
          REGFPRST2=${DIRREGFPRST2}/${PRJ}${RUN}${SUF}DY
             BTRST2=${DIRBTRST2}/${PRJ}${RUN}${SUF}DY
            RSDRST2=${DIRRSDRST2}/${PRJ}${RUN}${SUF}DY
           OUTBRST2=${DIROUTBRST2}/${PRJ}${RUN}${SUF}DY
            CWDRST2=${DIRCWDRST2}/${PRJ}${RUN}${SUF}DY
            CWSRST2=${DIRCWSRST2}/${PRJ}${RUN}${SUF}DY
         CWSGRNRST2=${DIRCWSGRNRST2}/${PRJ}${RUN}${SUF}DY
         CWSBLURST2=${DIRCWSBLURST2}/${PRJ}${RUN}${SUF}DY
       HEATUNITRST3=${DIRHEATUNITRST3}/${PRJ}${RUN}${SUF}DY
            SWURST3=${DIRSWURST3}/${PRJ}${RUN}${SUF}DY
            SWPRST3=${DIRSWPRST3}/${PRJ}${RUN}${SUF}DY
          REGFWRST3=${DIRREGFWRST3}/${PRJ}${RUN}${SUF}DY
          REGFLRST3=${DIRREGFLRST3}/${PRJ}${RUN}${SUF}DY
          REGFHRST3=${DIRREGFHRST3}/${PRJ}${RUN}${SUF}DY
          REGFNRST3=${DIRREGFNRST3}/${PRJ}${RUN}${SUF}DY
          REGFPRST3=${DIRREGFPRST3}/${PRJ}${RUN}${SUF}DY
             BTRST3=${DIRBTRST3}/${PRJ}${RUN}${SUF}DY
            RSDRST3=${DIRRSDRST3}/${PRJ}${RUN}${SUF}DY
           OUTBRST3=${DIROUTBRST3}/${PRJ}${RUN}${SUF}DY
            CWDRST3=${DIRCWDRST3}/${PRJ}${RUN}${SUF}DY
            CWSRST3=${DIRCWSRST3}/${PRJ}${RUN}${SUF}DY
         CWSGRNRST3=${DIRCWSGRNRST3}/${PRJ}${RUN}${SUF}DY
         CWSBLURST3=${DIRCWSBLURST3}/${PRJ}${RUN}${SUF}DY
       HEATUNITRST4=${DIRHEATUNITRST4}/${PRJ}${RUN}${SUF}DY
            SWURST4=${DIRSWURST4}/${PRJ}${RUN}${SUF}DY
            SWPRST4=${DIRSWPRST4}/${PRJ}${RUN}${SUF}DY
          REGFWRST4=${DIRREGFWRST4}/${PRJ}${RUN}${SUF}DY
          REGFLRST4=${DIRREGFLRST4}/${PRJ}${RUN}${SUF}DY
          REGFHRST4=${DIRREGFHRST4}/${PRJ}${RUN}${SUF}DY
          REGFNRST4=${DIRREGFNRST4}/${PRJ}${RUN}${SUF}DY
          REGFPRST4=${DIRREGFPRST4}/${PRJ}${RUN}${SUF}DY
             BTRST4=${DIRBTRST4}/${PRJ}${RUN}${SUF}DY
            RSDRST4=${DIRRSDRST4}/${PRJ}${RUN}${SUF}DY
           OUTBRST4=${DIROUTBRST4}/${PRJ}${RUN}${SUF}DY
            CWDRST4=${DIRCWDRST4}/${PRJ}${RUN}${SUF}DY
            CWSRST4=${DIRCWSRST4}/${PRJ}${RUN}${SUF}DY
         CWSGRNRST4=${DIRCWSGRNRST4}/${PRJ}${RUN}${SUF}DY
         CWSBLURST4=${DIRCWSBLURST4}/${PRJ}${RUN}${SUF}DY
         FLGCULRST1=${DIRFLGCULRST1}/${PRJ}${RUN}${SUF}DY          # Cultivation flag
         FLGCULRST2=${DIRFLGCULRST2}/${PRJ}${RUN}${SUF}DY
         FLGIRGRST1=${DIRFLGIRGRST1}/${PRJ}${RUN}${SUF}DY          # Irrigation flag
         FLGIRGRST2=${DIRFLGIRGRST2}/${PRJ}${RUN}${SUF}DY
         TARGETRST1=${DIRTARGETRST1}/${PRJ}${RUN}${SUF}DY          # Target ratio of irrigation
         TARGETRST2=${DIRTARGETRST2}/${PRJ}${RUN}${SUF}DY
          SUPAGRRST=${DIRSUPAGRRST}/${PRJ}${RUN}${SUF}DY           # Agricultural water supply
          MSRSTORST=${DIRMSRSTORST}/${PRJ}${RUN}${SUF}DY           # Storage of medium sized reservoirs
          DAMOUTRST=${DIRDAMOUTRST}/${PRJ}${RUN}${SUF}DY           # Outflow from dam
          DAMSTORST=${DIRDAMSTORST}/${PRJ}${RUN}${SUF}DY           # Storage of dam
            KRLSRST=${DIRKRLSRST}/${PRJ}${RUN}${SUF}DY             # Release coefficient
    FRCSUPAGRRIVRST=${DIRFRCSUPAGRRIVRST}/${PRJ}${RUN}${SUF}DY     # Fraction of agr. water supply from river
    FRCSUPAGRRGWRST=${DIRFRCSUPAGRRGWRST}/${PRJ}${RUN}${SUF}DY     # Fraction of agr. water supply from RGW
    FRCSUPAGRMSRRST=${DIRFRCSUPAGRMSRRST}/${PRJ}${RUN}${SUF}DY     # Fraction of agr. water supply from MSR
    FRCSUPAGRNNBRST=${DIRFRCSUPAGRNNBRST}/${PRJ}${RUN}${SUF}DY     # Fraction of agr. water supply from NNBW
FRCSOILMOISTGRNRST0=${DIRFRCSOILMOISTGRNRST0}/${PRJ}${RUN}${SUF}DY # Fraction of green SM
FRCSOILMOISTRIVRST0=${DIRFRCSOILMOISTRIVRST0}/${PRJ}${RUN}${SUF}DY # Fraction of river SM
FRCSOILMOISTMSRRST0=${DIRFRCSOILMOISTMSRRST0}/${PRJ}${RUN}${SUF}DY # Fraction of MSR SM
FRCSOILMOISTNNBRST0=${DIRFRCSOILMOISTNNBRST0}/${PRJ}${RUN}${SUF}DY # Fraction of NNBW SM
FRCSOILMOISTGRNRST1=${DIRFRCSOILMOISTGRNRST1}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTRIVRST1=${DIRFRCSOILMOISTRIVRST1}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTMSRRST1=${DIRFRCSOILMOISTMSRRST1}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTNNBRST1=${DIRFRCSOILMOISTNNBRST1}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTGRNRST2=${DIRFRCSOILMOISTGRNRST2}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTRIVRST2=${DIRFRCSOILMOISTRIVRST2}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTMSRRST2=${DIRFRCSOILMOISTMSRRST2}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTNNBRST2=${DIRFRCSOILMOISTNNBRST2}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTGRNRST3=${DIRFRCSOILMOISTGRNRST3}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTRIVRST3=${DIRFRCSOILMOISTRIVRST3}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTMSRRST3=${DIRFRCSOILMOISTMSRRST3}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTNNBRST3=${DIRFRCSOILMOISTNNBRST3}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTGRNRST4=${DIRFRCSOILMOISTGRNRST4}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTRIVRST4=${DIRFRCSOILMOISTRIVRST4}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTMSRRST4=${DIRFRCSOILMOISTMSRRST4}/${PRJ}${RUN}${SUF}DY
FRCSOILMOISTNNBRST4=${DIRFRCSOILMOISTNNBRST4}/${PRJ}${RUN}${SUF}DY
# Variables for yield calculation
      YLDOUT1STRST0=NO                                             # Crop yield
      CWDOUT1STRST0=NO                                             # Crop water demand
      CWSOUT1STRST0=NO                                             # Crop water supply
    REGFDOUT1STRST0=NO                                             # Dominant regulatio factor
   HVSDOYOUT1STRST0=NO                                             # Harvest day of the year
   CRPDAYOUT1STRST0=NO                                             # Cropping days
      YLDOUT2NDRST0=NO
      CWDOUT2NDRST0=NO
      CWSOUT2NDRST0=NO
    REGFDOUT2NDRST0=NO
   HVSDOYOUT2NDRST0=NO
   CRPDAYOUT2NDRST0=NO
      YLDOUT1STRST1=${DIRYLDOUT1STRST1}/${PRJ}${RUN}${SUF}DY
      CWDOUT1STRST1=${DIRCWDOUT1STRST1}/${PRJ}${RUN}${SUF}DY
      CWSOUT1STRST1=${DIRCWSOUT1STRST1}/${PRJ}${RUN}${SUF}DY
    REGFDOUT1STRST1=${DIRREGFDOUT1STRST1}/${PRJ}${RUN}${SUF}DY
   HVSDOYOUT1STRST1=${DIRHVSDOYOUT1STRST1}/${PRJ}${RUN}${SUF}DY
   CRPDAYOUT1STRST1=${DIRCRPDAYOUT1STRST1}/${PRJ}${RUN}${SUF}DY
      YLDOUT2NDRST1=${DIRYLDOUT2NDRST1}/${PRJ}${RUN}${SUF}DY
      CWDOUT2NDRST1=${DIRCWDOUT2NDRST1}/${PRJ}${RUN}${SUF}DY
      CWSOUT2NDRST1=${DIRCWSOUT2NDRST1}/${PRJ}${RUN}${SUF}DY
    REGFDOUT2NDRST1=${DIRREGFDOUT2NDRST1}/${PRJ}${RUN}${SUF}DY
   HVSDOYOUT2NDRST1=${DIRHVSDOYOUT2NDRST1}/${PRJ}${RUN}${SUF}DY
   CRPDAYOUT2NDRST1=${DIRCRPDAYOUT2NDRST1}/${PRJ}${RUN}${SUF}DY
      YLDOUT1STRST2=${DIRYLDOUT1STRST2}/${PRJ}${RUN}${SUF}DY
      CWDOUT1STRST2=${DIRCWDOUT1STRST2}/${PRJ}${RUN}${SUF}DY
      CWSOUT1STRST2=${DIRCWSOUT1STRST2}/${PRJ}${RUN}${SUF}DY
    REGFDOUT1STRST2=${DIRREGFDOUT1STRST2}/${PRJ}${RUN}${SUF}DY
   HVSDOYOUT1STRST2=${DIRHVSDOYOUT1STRST2}/${PRJ}${RUN}${SUF}DY
   CRPDAYOUT1STRST2=${DIRCRPDAYOUT1STRST2}/${PRJ}${RUN}${SUF}DY
      YLDOUT2NDRST2=${DIRYLDOUT2NDRST2}/${PRJ}${RUN}${SUF}DY
      CWDOUT2NDRST2=${DIRCWDOUT2NDRST2}/${PRJ}${RUN}${SUF}DY
      CWSOUT2NDRST2=${DIRCWSOUT2NDRST2}/${PRJ}${RUN}${SUF}DY
    REGFDOUT2NDRST2=${DIRREGFDOUT2NDRST2}/${PRJ}${RUN}${SUF}DY
   HVSDOYOUT2NDRST2=${DIRHVSDOYOUT2NDRST2}/${PRJ}${RUN}${SUF}DY
   CRPDAYOUT2NDRST2=${DIRCRPDAYOUT2NDRST2}/${PRJ}${RUN}${SUF}DY
      YLDOUT1STRST3=${DIRYLDOUT1STRST3}/${PRJ}${RUN}${SUF}DY
      CWDOUT1STRST3=${DIRCWDOUT1STRST3}/${PRJ}${RUN}${SUF}DY
      CWSOUT1STRST3=${DIRCWSOUT1STRST3}/${PRJ}${RUN}${SUF}DY
    REGFDOUT1STRST3=${DIRREGFDOUT1STRST3}/${PRJ}${RUN}${SUF}DY
   HVSDOYOUT1STRST3=${DIRHVSDOYOUT1STRST3}/${PRJ}${RUN}${SUF}DY
   CRPDAYOUT1STRST3=${DIRCRPDAYOUT1STRST3}/${PRJ}${RUN}${SUF}DY
      YLDOUT2NDRST3=${DIRYLDOUT2NDRST3}/${PRJ}${RUN}${SUF}DY
      CWDOUT2NDRST3=${DIRCWDOUT2NDRST3}/${PRJ}${RUN}${SUF}DY
      CWSOUT2NDRST3=${DIRCWSOUT2NDRST3}/${PRJ}${RUN}${SUF}DY
    REGFDOUT2NDRST3=${DIRREGFDOUT2NDRST3}/${PRJ}${RUN}${SUF}DY
   HVSDOYOUT2NDRST3=${DIRHVSDOYOUT2NDRST3}/${PRJ}${RUN}${SUF}DY
   CRPDAYOUT2NDRST3=${DIRCRPDAYOUT2NDRST3}/${PRJ}${RUN}${SUF}DY
      YLDOUT1STRST4=${DIRYLDOUT1STRST4}/${PRJ}${RUN}${SUF}DY
      CWDOUT1STRST4=${DIRCWDOUT1STRST4}/${PRJ}${RUN}${SUF}DY
      CWSOUT1STRST4=${DIRCWSOUT1STRST4}/${PRJ}${RUN}${SUF}DY
    REGFDOUT1STRST4=${DIRREGFDOUT1STRST4}/${PRJ}${RUN}${SUF}DY
   HVSDOYOUT1STRST4=${DIRHVSDOYOUT1STRST4}/${PRJ}${RUN}${SUF}DY
   CRPDAYOUT1STRST4=${DIRCRPDAYOUT1STRST4}/${PRJ}${RUN}${SUF}DY
      YLDOUT2NDRST4=${DIRYLDOUT2NDRST4}/${PRJ}${RUN}${SUF}DY
      CWDOUT2NDRST4=${DIRCWDOUT2NDRST4}/${PRJ}${RUN}${SUF}DY
      CWSOUT2NDRST4=${DIRCWSOUT2NDRST4}/${PRJ}${RUN}${SUF}DY
    REGFDOUT2NDRST4=${DIRREGFDOUT2NDRST4}/${PRJ}${RUN}${SUF}DY
   HVSDOYOUT2NDRST4=${DIRHVSDOYOUT2NDRST4}/${PRJ}${RUN}${SUF}DY
   CRPDAYOUT2NDRST4=${DIRCRPDAYOUT2NDRST4}/${PRJ}${RUN}${SUF}DY
   CWSOUT1STGRNRST0=NO                                             # Crop water supply from green water
   CWSOUT2NDGRNRST0=NO                                             # Crop water supply from blue water
   CWSOUT1STBLURST0=NO
   CWSOUT2NDBLURST0=NO
   CWSOUT1STGRNRST1=${DIRCWSOUT1STGRNRST1}/${PRJ}${RUN}${SUF}DY
   CWSOUT2NDGRNRST1=${DIRCWSOUT2NDGRNRST1}/${PRJ}${RUN}${SUF}DY
   CWSOUT1STBLURST1=${DIRCWSOUT1STBLURST1}/${PRJ}${RUN}${SUF}DY
   CWSOUT2NDBLURST1=${DIRCWSOUT2NDBLURST1}/${PRJ}${RUN}${SUF}DY
   CWSOUT1STGRNRST2=${DIRCWSOUT1STGRNRST2}/${PRJ}${RUN}${SUF}DY
   CWSOUT2NDGRNRST2=${DIRCWSOUT2NDGRNRST2}/${PRJ}${RUN}${SUF}DY
   CWSOUT1STBLURST2=${DIRCWSOUT1STBLURST2}/${PRJ}${RUN}${SUF}DY
   CWSOUT2NDBLURST2=${DIRCWSOUT2NDBLURST2}/${PRJ}${RUN}${SUF}DY
   CWSOUT1STGRNRST3=${DIRCWSOUT1STGRNRST3}/${PRJ}${RUN}${SUF}DY
   CWSOUT2NDGRNRST3=${DIRCWSOUT2NDGRNRST3}/${PRJ}${RUN}${SUF}DY
   CWSOUT1STBLURST3=${DIRCWSOUT1STBLURST3}/${PRJ}${RUN}${SUF}DY
   CWSOUT2NDBLURST3=${DIRCWSOUT2NDBLURST3}/${PRJ}${RUN}${SUF}DY
   CWSOUT1STGRNRST4=${DIRCWSOUT1STGRNRST4}/${PRJ}${RUN}${SUF}DY
   CWSOUT2NDGRNRST4=${DIRCWSOUT2NDGRNRST4}/${PRJ}${RUN}${SUF}DY
   CWSOUT1STBLURST4=${DIRCWSOUT1STBLURST4}/${PRJ}${RUN}${SUF}DY
   CWSOUT2NDBLURST4=${DIRCWSOUT2NDBLURST4}/${PRJ}${RUN}${SUF}DY
# Variables to save mothly/yearly aggregation
          DAMDEMRST=${DIRDAMDEMRST}/${PRJ}${RUN}${SUF}DY           # Water demand for indivisual res.            
          MSROUTRST=${DIRMSROUTRST}/${PRJ}${RUN}${SUF}DY           # Outflow from medium-sized res.
          SUPINDRST=${DIRSUPINDRST}/${PRJ}${RUN}${SUF}DY           # Industrial water supply
          SUPDOMRST=${DIRSUPDOMRST}/${PRJ}${RUN}${SUF}DY           # Domestic water supply
          LOSAGRRST=${DIRLOSAGRRST}/${PRJ}${RUN}${SUF}DY           # Water loss from agr.
          RTFAGRRST=${DIRRTFAGRRST}/${PRJ}${RUN}${SUF}DY           # Return flow from agr.
          RTFINDRST=${DIRRTFINDRST}/${PRJ}${RUN}${SUF}DY           # Return flow from ind.
          RTFDOMRST=${DIRRTFDOMRST}/${PRJ}${RUN}${SUF}DY           # Return flow from dom.
           EVAPRST0=${DIREVAPRST0}/${PRJ}${RUN}${SUF}DY            # Evapotranspiration
             QSRST0=${DIRQSRST0}/${PRJ}${RUN}${SUF}DY              # Surface runoff
            QSBRST0=${DIRQSBRST0}/${PRJ}${RUN}${SUF}DY             # Subsurface runoff
           QTOTRST0=${DIRQTOTRST0}/${PRJ}${RUN}${SUF}DY            # Total runoff
            QBFRST0=${DIRQBFRST0}/${PRJ}${RUN}${SUF}DY             # Baseflow
            QRCRST0=${DIRQRCRST0}/${PRJ}${RUN}${SUF}DY             # Recharge
           EVAPRST1=${DIREVAPRST1}/${PRJ}${RUN}${SUF}DY
             QSRST1=${DIRQSRST1}/${PRJ}${RUN}${SUF}DY
            QSBRST1=${DIRQSBRST1}/${PRJ}${RUN}${SUF}DY
           QTOTRST1=${DIRQTOTRST1}/${PRJ}${RUN}${SUF}DY
            QBFRST1=${DIRQBFRST1}/${PRJ}${RUN}${SUF}DY
            QRCRST1=${DIRQRCRST1}/${PRJ}${RUN}${SUF}DY
           EVAPRST2=${DIREVAPRST2}/${PRJ}${RUN}${SUF}DY
             QSRST2=${DIRQSRST2}/${PRJ}${RUN}${SUF}DY
            QSBRST2=${DIRQSBRST2}/${PRJ}${RUN}${SUF}DY
           QTOTRST2=${DIRQTOTRST2}/${PRJ}${RUN}${SUF}DY
            QBFRST2=${DIRQBFRST2}/${PRJ}${RUN}${SUF}DY
            QRCRST2=${DIRQRCRST2}/${PRJ}${RUN}${SUF}DY
           EVAPRST3=${DIREVAPRST3}/${PRJ}${RUN}${SUF}DY
             QSRST3=${DIRQSRST3}/${PRJ}${RUN}${SUF}DY
            QSBRST3=${DIRQSBRST3}/${PRJ}${RUN}${SUF}DY
           QTOTRST3=${DIRQTOTRST3}/${PRJ}${RUN}${SUF}DY
            QBFRST3=${DIRQBFRST3}/${PRJ}${RUN}${SUF}DY
            QRCRST3=${DIRQRCRST3}/${PRJ}${RUN}${SUF}DY
           EVAPRST4=${DIREVAPRST4}/${PRJ}${RUN}${SUF}DY
             QSRST4=${DIRQSRST4}/${PRJ}${RUN}${SUF}DY
            QSBRST4=${DIRQSBRST4}/${PRJ}${RUN}${SUF}DY
           QTOTRST4=${DIRQTOTRST4}/${PRJ}${RUN}${SUF}DY
            QBFRST4=${DIRQBFRST4}/${PRJ}${RUN}${SUF}DY
            QRCRST4=${DIRQRCRST4}/${PRJ}${RUN}${SUF}DY
############################################################
...
if [ ! -d $DIRCRPDAYRST3          ]; then mkdir -p $DIRCRPDAYRST3;          fi
if [ ! -d $DIRCRPDAYRST4          ]; then mkdir -p $DIRCRPDAYRST4;          fi
if [ ! -d $DIRHEATUNITRST0        ]; then mkdir -p $DIRHEATUNITRST0;        fi
if [ ! -d $DIRSWURST0             ]; then mkdir -p $DIRSWURST0;             fi
if [ ! -d $DIRSWPRST0             ]; then mkdir -p $DIRSWPRST0;             fi
if [ ! -d $DIRREGFWRST0           ]; then mkdir -p $DIRREGFWRST0;           fi
if [ ! -d $DIRREGFLRST0           ]; then mkdir -p $DIRREGFLRST0;           fi
if [ ! -d $DIRREGFHRST0           ]; then mkdir -p $DIRREGFHRST0;           fi
if [ ! -d $DIRREGFNRST0           ]; then mkdir -p $DIRREGFNRST0;           fi
if [ ! -d $DIRREGFPRST0           ]; then mkdir -p $DIRREGFPRST0;           fi
if [ ! -d $DIRBTRST0              ]; then mkdir -p $DIRBTRST0;              fi
if [ ! -d $DIRRSDRST0             ]; then mkdir -p $DIRRSDRST0;             fi
if [ ! -d $DIROUTBRST0            ]; then mkdir -p $DIROUTBRST0;            fi
if [ ! -d $DIRCWDRST0             ]; then mkdir -p $DIRCWDRST0;             fi
if [ ! -d $DIRCWSRST0             ]; then mkdir -p $DIRCWSRST0;             fi
if [ ! -d $DIRCWSGRNRST0          ]; then mkdir -p $DIRCWSGRNRST0;          fi
if [ ! -d $DIRCWSBLURST0          ]; then mkdir -p $DIRCWSBLURST0;          fi
if [ ! -d $DIRHEATUNITRST1        ]; then mkdir -p $DIRHEATUNITRST1;        fi
if [ ! -d $DIRSWURST1             ]; then mkdir -p $DIRSWURST1;             fi
if [ ! -d $DIRSWPRST1             ]; then mkdir -p $DIRSWPRST1;             fi
if [ ! -d $DIRREGFWRST1           ]; then mkdir -p $DIRREGFWRST1;           fi
if [ ! -d $DIRREGFLRST1           ]; then mkdir -p $DIRREGFLRST1;           fi
if [ ! -d $DIRREGFHRST1           ]; then mkdir -p $DIRREGFHRST1;           fi
if [ ! -d $DIRREGFNRST1           ]; then mkdir -p $DIRREGFNRST1;           fi
if [ ! -d $DIRREGFPRST1           ]; then mkdir -p $DIRREGFPRST1;           fi
if [ ! -d $DIRBTRST1              ]; then mkdir -p $DIRBTRST1;              fi
if [ ! -d $DIRRSDRST1             ]; then mkdir -p $DIRRSDRST1;             fi
if [ ! -d $DIROUTBRST1            ]; then mkdir -p $DIROUTBRST1;            fi
if [ ! -d $DIRCWDRST1             ]; then mkdir -p $DIRCWDRST1;             fi
if [ ! -d $DIRCWSRST1             ]; then mkdir -p $DIRCWSRST1;             fi
if [ ! -d $DIRCWSGRNRST1          ]; then mkdir -p $DIRCWSGRNRST1;          fi
if [ ! -d $DIRCWSBLURST1          ]; then mkdir -p $DIRCWSBLURST1;          fi
if [ ! -d $DIRHEATUNITRST2        ]; then mkdir -p $DIRHEATUNITRST2;        fi
if [ ! -d $DIRSWURST2             ]; then mkdir -p $DIRSWURST2;             fi
if [ ! -d $DIRSWPRST2             ]; then mkdir -p $DIRSWPRST2;             fi
if [ ! -d $DIRREGFWRST2           ]; then mkdir -p $DIRREGFWRST2;           fi
if [ ! -d $DIRREGFLRST2           ]; then mkdir -p $DIRREGFLRST2;           fi
if [ ! -d $DIRREGFHRST2           ]; then mkdir -p $DIRREGFHRST2;           fi
if [ ! -d $DIRREGFNRST2           ]; then mkdir -p $DIRREGFNRST2;           fi
if [ ! -d $DIRREGFPRST2           ]; then mkdir -p $DIRREGFPRST2;           fi
if [ ! -d $DIRBTRST2              ]; then mkdir -p $DIRBTRST2;              fi
if [ ! -d $DIRRSDRST2             ]; then mkdir -p $DIRRSDRST2;             fi
if [ ! -d $DIROUTBRST2            ]; then mkdir -p $DIROUTBRST2;            fi
if [ ! -d $DIRCWDRST2             ]; then mkdir -p $DIRCWDRST2;             fi
if [ ! -d $DIRCWSRST2             ]; then mkdir -p $DIRCWSRST2;             fi
if [ ! -d $DIRCWSGRNRST2          ]; then mkdir -p $DIRCWSGRNRST2;          fi
if [ ! -d $DIRCWSBLURST2          ]; then mkdir -p $DIRCWSBLURST2;          fi
if [ ! -d $DIRHEATUNITRST3        ]; then mkdir -p $DIRHEATUNITRST3;        fi
if [ ! -d $DIRSWURST3             ]; then mkdir -p $DIRSWURST3;             fi
if [ ! -d $DIRSWPRST3             ]; then mkdir -p $DIRSWPRST3;             fi
if [ ! -d $DIRREGFWRST3           ]; then mkdir -p $DIRREGFWRST3;           fi
if [ ! -d $DIRREGFLRST3           ]; then mkdir -p $DIRREGFLRST3;           fi
if [ ! -d $DIRREGFHRST3           ]; then mkdir -p $DIRREGFHRST3;           fi
if [ ! -d $DIRREGFNRST3           ]; then mkdir -p $DIRREGFNRST3;           fi
if [ ! -d $DIRREGFPRST3           ]; then mkdir -p $DIRREGFPRST3;           fi
if [ ! -d $DIRBTRST3              ]; then mkdir -p $DIRBTRST3;              fi
if [ ! -d $DIRRSDRST3             ]; then mkdir -p $DIRRSDRST3;             fi
if [ ! -d $DIROUTBRST3            ]; then mkdir -p $DIROUTBRST3;            fi
if [ ! -d $DIRCWDRST3             ]; then mkdir -p $DIRCWDRST3;             fi
if [ ! -d $DIRCWSRST3             ]; then mkdir -p $DIRCWSRST3;             fi
if [ ! -d $DIRCWSGRNRST3          ]; then mkdir -p $DIRCWSGRNRST3;          fi
if [ ! -d $DIRCWSBLURST3          ]; then mkdir -p $DIRCWSBLURST3;          fi
if [ ! -d $DIRHEATUNITRST4        ]; then mkdir -p $DIRHEATUNITRST4;        fi
if [ ! -d $DIRSWURST4             ]; then mkdir -p $DIRSWURST4;             fi
if [ ! -d $DIRSWPRST4             ]; then mkdir -p $DIRSWPRST4;             fi
if [ ! -d $DIRREGFWRST4           ]; then mkdir -p $DIRREGFWRST4;           fi
if [ ! -d $DIRREGFLRST4           ]; then mkdir -p $DIRREGFLRST4;           fi
if [ ! -d $DIRREGFHRST4           ]; then mkdir -p $DIRREGFHRST4;           fi
if [ ! -d $DIRREGFNRST4           ]; then mkdir -p $DIRREGFNRST4;           fi
if [ ! -d $DIRREGFPRST4           ]; then mkdir -p $DIRREGFPRST4;           fi
if [ ! -d $DIRBTRST4              ]; then mkdir -p $DIRBTRST4;              fi
if [ ! -d $DIRRSDRST4             ]; then mkdir -p $DIRRSDRST4;             fi
if [ ! -d $DIROUTBRST4            ]; then mkdir -p $DIROUTBRST4;            fi
if [ ! -d $DIRCWDRST4             ]; then mkdir -p $DIRCWDRST4;             fi
if [ ! -d $DIRCWSRST4             ]; then mkdir -p $DIRCWSRST4;             fi
if [ ! -d $DIRCWSGRNRST4          ]; then mkdir -p $DIRCWSGRNRST4;          fi
if [ ! -d $DIRCWSBLURST4          ]; then mkdir -p $DIRCWSBLURST4;          fi
if [ ! -d $DIRFLGCULRST1          ]; then mkdir -p $DIRFLGCULRST1;          fi
if [ ! -d $DIRFLGCULRST2          ]; then mkdir -p $DIRFLGCULRST2;          fi
if [ ! -d $DIRFLGIRGRST1          ]; then mkdir -p $DIRFLGIRGRST1;          fi
if [ ! -d $DIRFLGIRGRST2          ]; then mkdir -p $DIRFLGIRGRST2;          fi
if [ ! -d $DIRTARGETRST1          ]; then mkdir -p $DIRTARGETRST1;          fi
if [ ! -d $DIRTARGETRST2          ]; then mkdir -p $DIRTARGETRST2;          fi
if [ ! -d $DIRSUPAGRRST           ]; then mkdir -p $DIRSUPAGRRST;           fi
if [ ! -d $DIRMSRSTORST           ]; then mkdir -p $DIRMSRSTORST;           fi
if [ ! -d $DIRDAMOUTRST           ]; then mkdir -p $DIRDAMOUTRST;           fi
if [ ! -d $DIRDAMSTORST           ]; then mkdir -p $DIRDAMSTORST;           fi
if [ ! -d $DIRKRLSRST             ]; then mkdir -p $DIRKRLSRST;             fi
if [ ! -d $DIRFRCSUPAGRRIVRST     ]; then mkdir -p $DIRFRCSUPAGRRIVRST;     fi
if [ ! -d $DIRFRCSUPAGRRGWRST     ]; then mkdir -p $DIRFRCSUPAGRRGWRST;     fi
if [ ! -d $DIRFRCSUPAGRMSRRST     ]; then mkdir -p $DIRFRCSUPAGRMSRRST;     fi
if [ ! -d $DIRFRCSUPAGRNNBRST     ]; then mkdir -p $DIRFRCSUPAGRNNBRST;     fi
if [ ! -d $DIRFRCSOILMOISTGRNRST0 ]; then mkdir -p $DIRFRCSOILMOISTGRNRST0; fi
if [ ! -d $DIRFRCSOILMOISTRIVRST0 ]; then mkdir -p $DIRFRCSOILMOISTRIVRST0; fi
if [ ! -d $DIRFRCSOILMOISTMSRRST0 ]; then mkdir -p $DIRFRCSOILMOISTMSRRST0; fi
if [ ! -d $DIRFRCSOILMOISTNNBRST0 ]; then mkdir -p $DIRFRCSOILMOISTNNBRST0; fi
if [ ! -d $DIRFRCSOILMOISTGRNRST1 ]; then mkdir -p $DIRFRCSOILMOISTGRNRST1; fi
if [ ! -d $DIRFRCSOILMOISTRIVRST1 ]; then mkdir -p $DIRFRCSOILMOISTRIVRST1; fi
if [ ! -d $DIRFRCSOILMOISTMSRRST1 ]; then mkdir -p $DIRFRCSOILMOISTMSRRST1; fi
if [ ! -d $DIRFRCSOILMOISTNNBRST1 ]; then mkdir -p $DIRFRCSOILMOISTNNBRST1; fi
if [ ! -d $DIRFRCSOILMOISTGRNRST2 ]; then mkdir -p $DIRFRCSOILMOISTGRNRST2; fi
if [ ! -d $DIRFRCSOILMOISTRIVRST2 ]; then mkdir -p $DIRFRCSOILMOISTRIVRST2; fi
if [ ! -d $DIRFRCSOILMOISTMSRRST2 ]; then mkdir -p $DIRFRCSOILMOISTMSRRST2; fi
if [ ! -d $DIRFRCSOILMOISTNNBRST2 ]; then mkdir -p $DIRFRCSOILMOISTNNBRST2; fi
if [ ! -d $DIRFRCSOILMOISTGRNRST3 ]; then mkdir -p $DIRFRCSOILMOISTGRNRST3; fi
if [ ! -d $DIRFRCSOILMOISTRIVRST3 ]; then mkdir -p $DIRFRCSOILMOISTRIVRST3; fi
if [ ! -d $DIRFRCSOILMOISTMSRRST3 ]; then mkdir -p $DIRFRCSOILMOISTMSRRST3; fi
if [ ! -d $DIRFRCSOILMOISTNNBRST3 ]; then mkdir -p $DIRFRCSOILMOISTNNBRST3; fi
if [ ! -d $DIRFRCSOILMOISTGRNRST4 ]; then mkdir -p $DIRFRCSOILMOISTGRNRST4; fi
if [ ! -d $DIRFRCSOILMOISTRIVRST4 ]; then mkdir -p $DIRFRCSOILMOISTRIVRST4; fi
if [ ! -d $DIRFRCSOILMOISTMSRRST4 ]; then mkdir -p $DIRFRCSOILMOISTMSRRST4; fi
if [ ! -d $DIRFRCSOILMOISTNNBRST4 ]; then mkdir -p $DIRFRCSOILMOISTNNBRST4; fi

if [ ! -d $DIRYLDOUT1STRST1       ]; then mkdir -p $DIRYLDOUT1STRST1;       fi
if [ ! -d $DIRCWDOUT1STRST1       ]; then mkdir -p $DIRCWDOUT1STRST1;       fi
if [ ! -d $DIRCWSOUT1STRST1       ]; then mkdir -p $DIRCWSOUT1STRST1;       fi
if [ ! -d $DIRREGFDOUT1STRST1     ]; then mkdir -p $DIRREGFDOUT1STRST1;     fi
if [ ! -d $DIRHVSDOYOUT1STRST1    ]; then mkdir -p $DIRHVSDOYOUT1STRST1;    fi
if [ ! -d $DIRCRPDAYOUT1STRST1    ]; then mkdir -p $DIRCRPDAYOUT1STRST1;    fi
if [ ! -d $DIRYLDOUT2NDRST1       ]; then mkdir -p $DIRYLDOUT2NDRST1;       fi
if [ ! -d $DIRCWDOUT2NDRST1       ]; then mkdir -p $DIRCWDOUT2NDRST1;       fi
if [ ! -d $DIRCWSOUT2NDRST1       ]; then mkdir -p $DIRCWSOUT2NDRST1;       fi
if [ ! -d $DIRREGFDOUT2NDRST1     ]; then mkdir -p $DIRREGFDOUT2NDRST1;     fi
if [ ! -d $DIRHVSDOYOUT2NDRST1    ]; then mkdir -p $DIRHVSDOYOUT2NDRST1;    fi
if [ ! -d $DIRCRPDAYOUT2NDRST1    ]; then mkdir -p $DIRCRPDAYOUT2NDRST1;    fi
if [ ! -d $DIRYLDOUT1STRST2       ]; then mkdir -p $DIRYLDOUT1STRST2;       fi
if [ ! -d $DIRCWDOUT1STRST2       ]; then mkdir -p $DIRCWDOUT1STRST2;       fi
if [ ! -d $DIRCWSOUT1STRST2       ]; then mkdir -p $DIRCWSOUT1STRST2;       fi
if [ ! -d $DIRREGFDOUT1STRST2     ]; then mkdir -p $DIRREGFDOUT1STRST2;     fi
if [ ! -d $DIRHVSDOYOUT1STRST2    ]; then mkdir -p $DIRHVSDOYOUT1STRST2;    fi
if [ ! -d $DIRCRPDAYOUT1STRST2    ]; then mkdir -p $DIRCRPDAYOUT1STRST2;    fi
if [ ! -d $DIRYLDOUT2NDRST2       ]; then mkdir -p $DIRYLDOUT2NDRST2;       fi
if [ ! -d $DIRCWDOUT2NDRST2       ]; then mkdir -p $DIRCWDOUT2NDRST2;       fi
if [ ! -d $DIRCWSOUT2NDRST2       ]; then mkdir -p $DIRCWSOUT2NDRST2;       fi
if [ ! -d $DIRREGFDOUT2NDRST2     ]; then mkdir -p $DIRREGFDOUT2NDRST2;     fi
if [ ! -d $DIRHVSDOYOUT2NDRST2    ]; then mkdir -p $DIRHVSDOYOUT2NDRST2;    fi
if [ ! -d $DIRCRPDAYOUT2NDRST2    ]; then mkdir -p $DIRCRPDAYOUT2NDRST2;    fi
if [ ! -d $DIRYLDOUT1STRST3       ]; then mkdir -p $DIRYLDOUT1STRST3;       fi
if [ ! -d $DIRCWDOUT1STRST3       ]; then mkdir -p $DIRCWDOUT1STRST3;       fi
if [ ! -d $DIRCWSOUT1STRST3       ]; then mkdir -p $DIRCWSOUT1STRST3;       fi
if [ ! -d $DIRREGFDOUT1STRST3     ]; then mkdir -p $DIRREGFDOUT1STRST3;     fi
if [ ! -d $DIRHVSDOYOUT1STRST3    ]; then mkdir -p $DIRHVSDOYOUT1STRST3;    fi
if [ ! -d $DIRCRPDAYOUT1STRST3    ]; then mkdir -p $DIRCRPDAYOUT1STRST3;    fi
if [ ! -d $DIRYLDOUT2NDRST3       ]; then mkdir -p $DIRYLDOUT2NDRST3;       fi
if [ ! -d $DIRCWDOUT2NDRST3       ]; then mkdir -p $DIRCWDOUT2NDRST3;       fi
if [ ! -d $DIRCWSOUT2NDRST3       ]; then mkdir -p $DIRCWSOUT2NDRST3;       fi
if [ ! -d $DIRREGFDOUT2NDRST3     ]; then mkdir -p $DIRREGFDOUT2NDRST3;     fi
if [ ! -d $DIRHVSDOYOUT2NDRST3    ]; then mkdir -p $DIRHVSDOYOUT2NDRST3;    fi
if [ ! -d $DIRCRPDAYOUT2NDRST3    ]; then mkdir -p $DIRCRPDAYOUT2NDRST3;    fi
if [ ! -d $DIRYLDOUT1STRST4       ]; then mkdir -p $DIRYLDOUT1STRST4;       fi
if [ ! -d $DIRCWDOUT1STRST4       ]; then mkdir -p $DIRCWDOUT1STRST4;       fi
if [ ! -d $DIRCWSOUT1STRST4       ]; then mkdir -p $DIRCWSOUT1STRST4;       fi
if [ ! -d $DIRREGFDOUT1STRST4     ]; then mkdir -p $DIRREGFDOUT1STRST4;     fi
if [ ! -d $DIRHVSDOYOUT1STRST4    ]; then mkdir -p $DIRHVSDOYOUT1STRST4;    fi
if [ ! -d $DIRCRPDAYOUT1STRST4    ]; then mkdir -p $DIRCRPDAYOUT1STRST4;    fi
if [ ! -d $DIRYLDOUT2NDRST4       ]; then mkdir -p $DIRYLDOUT2NDRST4;       fi
if [ ! -d $DIRCWDOUT2NDRST4       ]; then mkdir -p $DIRCWDOUT2NDRST4;       fi
if [ ! -d $DIRCWSOUT2NDRST4       ]; then mkdir -p $DIRCWSOUT2NDRST4;       fi
if [ ! -d $DIRREGFDOUT2NDRST4     ]; then mkdir -p $DIRREGFDOUT2NDRST4;     fi
if [ ! -d $DIRHVSDOYOUT2NDRST4    ]; then mkdir -p $DIRHVSDOYOUT2NDRST4;    fi
if [ ! -d $DIRCRPDAYOUT2NDRST4    ]; then mkdir -p $DIRCRPDAYOUT2NDRST4;    fi
if [ ! -d $DIRCWSOUT1STGRNRST1    ]; then mkdir -p $DIRCWSOUT1STGRNRST1;    fi
if [ ! -d $DIRCWSOUT2NDGRNRST1    ]; then mkdir -p $DIRCWSOUT2NDGRNRST1;    fi
if [ ! -d $DIRCWSOUT1STBLURST1    ]; then mkdir -p $DIRCWSOUT1STBLURST1;    fi
if [ ! -d $DIRCWSOUT2NDBLURST1    ]; then mkdir -p $DIRCWSOUT2NDBLURST1;    fi
if [ ! -d $DIRCWSOUT1STGRNRST2    ]; then mkdir -p $DIRCWSOUT1STGRNRST2;    fi
if [ ! -d $DIRCWSOUT2NDGRNRST2    ]; then mkdir -p $DIRCWSOUT2NDGRNRST2;    fi
if [ ! -d $DIRCWSOUT1STBLURST2    ]; then mkdir -p $DIRCWSOUT1STBLURST2;    fi
if [ ! -d $DIRCWSOUT2NDBLURST2    ]; then mkdir -p $DIRCWSOUT2NDBLURST2;    fi
if [ ! -d $DIRCWSOUT1STGRNRST3    ]; then mkdir -p $DIRCWSOUT1STGRNRST3;    fi
if [ ! -d $DIRCWSOUT2NDGRNRST3    ]; then mkdir -p $DIRCWSOUT2NDGRNRST3;    fi
if [ ! -d $DIRCWSOUT1STBLURST3    ]; then mkdir -p $DIRCWSOUT1STBLURST3;    fi
if [ ! -d $DIRCWSOUT2NDBLURST3    ]; then mkdir -p $DIRCWSOUT2NDBLURST3;    fi
if [ ! -d $DIRCWSOUT1STGRNRST4    ]; then mkdir -p $DIRCWSOUT1STGRNRST4;    fi
if [ ! -d $DIRCWSOUT2NDGRNRST4    ]; then mkdir -p $DIRCWSOUT2NDGRNRST4;    fi
if [ ! -d $DIRCWSOUT1STBLURST4    ]; then mkdir -p $DIRCWSOUT1STBLURST4;    fi
if [ ! -d $DIRCWSOUT2NDBLURST4    ]; then mkdir -p $DIRCWSOUT2NDBLURST4;    fi

if [ ! -d $DIRDAMDEMRST           ]; then mkdir -p $DIRDAMDEMRST;           fi
if [ ! -d $DIRMSROUTRST           ]; then mkdir -p $DIRMSROUTRST;           fi
if [ ! -d $DIRSUPINDRST           ]; then mkdir -p $DIRSUPINDRST;           fi
if [ ! -d $DIRSUPDOMRST           ]; then mkdir -p $DIRSUPDOMRST;           fi
if [ ! -d $DIRLOSAGRRST           ]; then mkdir -p $DIRLOSAGRRST;           fi
if [ ! -d $DIRRTFAGRRST           ]; then mkdir -p $DIRRTFAGRRST;           fi
if [ ! -d $DIRRTFINDRST           ]; then mkdir -p $DIRRTFINDRST;           fi
if [ ! -d $DIRRTFDOMRST           ]; then mkdir -p $DIRRTFDOMRST;           fi
if [ ! -d $DIREVAPRST0            ]; then mkdir -p $DIREVAPRST0;            fi
if [ ! -d $DIRQSRST0              ]; then mkdir -p $DIRQSRST0;              fi
if [ ! -d $DIRQSBRST0             ]; then mkdir -p $DIRQSBRST0;             fi
if [ ! -d $DIRQTOTRST0            ]; then mkdir -p $DIRQTOTRST0;            fi
if [ ! -d $DIRQBFRST0             ]; then mkdir -p $DIRQBFRST0;             fi
if [ ! -d $DIRQRCRST0             ]; then mkdir -p $DIRQRCRST0;             fi
if [ ! -d $DIREVAPRST1            ]; then mkdir -p $DIREVAPRST1;            fi
if [ ! -d $DIRQSRST1              ]; then mkdir -p $DIRQSRST1;              fi
if [ ! -d $DIRQSBRST1             ]; then mkdir -p $DIRQSBRST1;             fi
if [ ! -d $DIRQTOTRST1            ]; then mkdir -p $DIRQTOTRST1;            fi
if [ ! -d $DIRQBFRST1             ]; then mkdir -p $DIRQBFRST1;             fi
if [ ! -d $DIRQRCRST1             ]; then mkdir -p $DIRQRCRST1;             fi
if [ ! -d $DIREVAPRST2            ]; then mkdir -p $DIREVAPRST2;            fi
if [ ! -d $DIRQSRST2              ]; then mkdir -p $DIRQSRST2;              fi
if [ ! -d $DIRQSBRST2             ]; then mkdir -p $DIRQSBRST2;             fi
if [ ! -d $DIRQTOTRST2            ]; then mkdir -p $DIRQTOTRST2;            fi
if [ ! -d $DIRQBFRST2             ]; then mkdir -p $DIRQBFRST2;             fi
if [ ! -d $DIRQRCRST2             ]; then mkdir -p $DIRQRCRST2;             fi
if [ ! -d $DIREVAPRST3            ]; then mkdir -p $DIREVAPRST3;            fi
if [ ! -d $DIRQSRST3              ]; then mkdir -p $DIRQSRST3;              fi
if [ ! -d $DIRQSBRST3             ]; then mkdir -p $DIRQSBRST3;             fi
if [ ! -d $DIRQTOTRST3            ]; then mkdir -p $DIRQTOTRST3;            fi
if [ ! -d $DIRQBFRST3             ]; then mkdir -p $DIRQBFRST3;             fi
if [ ! -d $DIRQRCRST3             ]; then mkdir -p $DIRQRCRST3;             fi
if [ ! -d $DIREVAPRST4            ]; then mkdir -p $DIREVAPRST4;            fi
if [ ! -d $DIRQSRST4              ]; then mkdir -p $DIRQSRST4;              fi
if [ ! -d $DIRQSBRST4             ]; then mkdir -p $DIRQSBRST4;             fi
if [ ! -d $DIRQTOTRST4            ]; then mkdir -p $DIRQTOTRST4;            fi
if [ ! -d $DIRQBFRST4             ]; then mkdir -p $DIRQBFRST4;             fi
if [ ! -d $DIRQRCRST4             ]; then mkdir -p $DIRQRCRST4;             fi
############################################################
...
LOGFILE=${DIRLOG}/${PRJ}${RUN}${RUNDATE}.log
############################################################
# Job (Making SET file (Restart))
############################################################
DIRSET=../../rst/set
if [ ! -d $DIRSET ]; then
  mkdir -p $DIRSET
fi
SETRST=${DIRSET}/${PRJ}${RUN}${RUNDATE}.set
#
if [ -f $SETRST ]; then
  rm $SETRST
fi
...
cat <<EOF>> $SETRST
&setrst
i0rstbgnflg=$RSTBGNFLG
i0rstendflg=$RSTENDFLG
i0yearrstbgn=$YEARRSTBGN
i0monrstbgn=$MONRSTBGN
i0dayrstbgn=$DAYRSTBGN
i0yearrstend=$YEARRSTEND
i0monrstend=$MONRSTEND
i0dayrstend=$DAYRSTEND
...
c0krlsrst='$KRLSRST'
c0supagrrst='$SUPAGRRST'
c0frcsupagrrivrst='$FRCSUPAGRRIVRST'
c0frcsupagrrgwrst='$FRCSUPAGRRGWRST'
c0frcsupagrmsrrst='$FRCSUPAGRMSRRST'
c0frcsupagrnnbrst='$FRCSUPAGRNNBRST'

c1flgculrst(1)='$FLGCULRST1'
c1flgculrst(2)='$FLGCULRST2'
c1flgirgrst(1)='$FLGIRGRST1'
c1flgirgrst(2)='$FLGIRGRST2'
...
c1rgwrst(0)='$GWRST0'
c1crpdayrst(0)='$CRPDAYRST0'
c1hunarst(0)='$HEATUNITRST0'
c1swurst(0)='$SWURST0'
c1swprst(0)='$SWPRST0'
c1regfwrst(0)='$REGFWRST0'
c1regflrst(0)='$REGFLRST0'
c1regfhrst(0)='$REGFHRST0'
c1regfnrst(0)='$REGFNRST0'
c1regfprst(0)='$REGFPRST0'
c1btrst(0)='$BTRST0'
c1rsdrst(0)='$RSDRST0'
c1outbrst(0)='$OUTBRST0'
c1cwdrst(0)='$CWDRST0'
c1cwsrst(0)='$CWSRST0'
c1cwsgrnrst(0)='$CWSGRNRST0'
c1cwsblurst(0)='$CWSBLURST0'
c1frcsoilmoistgrnrst(0)='$FRCSOILMOISTGRNRST0'
...
c1rgwrst(1)='$GWRST1'
c1crpdayrst(1)='$CRPDAYRST1'
c1hunarst(1)='$HEATUNITRST1'
c1swurst(1)='$SWURST1'
c1swprst(1)='$SWPRST1'
c1regfwrst(1)='$REGFWRST1'
c1regflrst(1)='$REGFLRST1'
c1regfhrst(1)='$REGFHRST1'
c1regfnrst(1)='$REGFNRST1'
c1regfprst(1)='$REGFPRST1'
c1btrst(1)='$BTRST1'
c1rsdrst(1)='$RSDRST1'
c1outbrst(1)='$OUTBRST1'
c1cwdrst(1)='$CWDRST1'
c1cwsrst(1)='$CWSRST1'
c1cwsgrnrst(1)='$CWSGRNRST1'
c1cwsblurst(1)='$CWSBLURST1'
c1frcsoilmoistgrnrst(1)='$FRCSOILMOISTGRNRST1'
c1frcsoilmoistrivrst(1)='$FRCSOILMOISTRIVRST1'
c1frcsoilmoistmsrrst(1)='$FRCSOILMOISTMSRRST1'
c1frcsoilmoistnnbrst(1)='$FRCSOILMOISTNNBRST1'

c1yldout1strst(0)='$YLDOUT1STRST0'
c1cwdout1strst(0)='$CWDOUT1STRST0'
c1cwsout1strst(0)='$CWSOUT1STRST0'
c1regfdout1strst(0)='$REGFDOUT1STRST0'
c1hvsdoyout1strst(0)='$HVSDOYOUT1STRST0'
c1crpdayout1strst(0)='$CRPDAYOUT1STRST0'
c1yldout2ndrst(0)='$YLDOUT2NDRST0'
c1cwdout2ndrst(0)='$CWDOUT2NDRST0'
c1cwsout2ndrst(0)='$CWSOUT2NDRST0'
c1regfdout2ndrst(0)='$REGFDOUT2NDRST0'
c1hvsdoyout2ndrst(0)='$HVSDOYOUT2NDRST0'
c1crpdayout2ndrst(0)='$CRPDAYOUT2NDRST0'
c1cwsout1stgrnrst(0)='$CWSOUT1STGRNRST0'
c1cwsout1stblurst(0)='$CWSOUT1STBLURST0'
c1cwsout2ndgrnrst(0)='$CWSOUT2NDGRNRST0'
c1cwsout2ndblurst(0)='$CWSOUT2NDBLURST0'
c1yldout1strst(1)='$YLDOUT1STRST1'
c1cwdout1strst(1)='$CWDOUT1STRST1'
c1cwsout1strst(1)='$CWSOUT1STRST1'
c1regfdout1strst(1)='$REGFDOUT1STRST1'
c1hvsdoyout1strst(1)='$HVSDOYOUT1STRST1'
c1crpdayout1strst(1)='$CRPDAYOUT1STRST1'
c1yldout2ndrst(1)='$YLDOUT2NDRST1'
c1cwdout2ndrst(1)='$CWDOUT2NDRST1'
c1cwsout2ndrst(1)='$CWSOUT2NDRST1'
c1regfdout2ndrst(1)='$REGFDOUT2NDRST1'
c1hvsdoyout2ndrst(1)='$HVSDOYOUT2NDRST1'
c1crpdayout2ndrst(1)='$CRPDAYOUT2NDRST1'
c1cwsout1stgrnrst(1)='$CWSOUT1STGRNRST1'
c1cwsout1stblurst(1)='$CWSOUT1STBLURST1'
c1cwsout2ndgrnrst(1)='$CWSOUT2NDGRNRST1'
c1cwsout2ndblurst(1)='$CWSOUT2NDBLURST1'

c0damdemrst='$DAMDEMRST'
c0msroutrst='$MSROUTRST'
c0supindrst='$SUPINDRST'
c0supdomrst='$SUPDOMRST'
c0losagrrst='$LOSAGRRST'
c0rtfagrrst='$RTFAGRRST'
c0rtfindrst='$RTFINDRST'
c0rtfdomrst='$RTFDOMRST'
c1evaprst(0)='$EVAPRST0'
c1qsrst(0)='$QSRST0'
c1qsbrst(0)='$QSBRST0'
c1qtotrst(0)='$QTOTRST0'
c1qbfrst(0)='$QBFRST0'
c1qrcrst(0)='$QRCRST0'
c1evaprst(1)='$EVAPRST1'
c1qsrst(1)='$QSRST1'
c1qsbrst(1)='$QSBRST1'
c1qtotrst(1)='$QTOTRST1'
c1qbfrst(1)='$QBFRST1'
c1qrcrst(1)='$QRCRST1'
...
c1rgwrst(2)='$GWRST2'
c1crpdayrst(2)='$CRPDAYRST2'
c1hunarst(2)='$HEATUNITRST2'
c1swurst(2)='$SWURST2'
c1swprst(2)='$SWPRST2'
c1regfwrst(2)='$REGFWRST2'
c1regflrst(2)='$REGFLRST2'
c1regfhrst(2)='$REGFHRST2'
c1regfnrst(2)='$REGFNRST2'
c1regfprst(2)='$REGFPRST2'
c1btrst(2)='$BTRST2'
c1rsdrst(2)='$RSDRST2'
c1outbrst(2)='$OUTBRST2'
c1cwdrst(2)='$CWDRST2'
c1cwsrst(2)='$CWSRST2'
c1cwsgrnrst(2)='$CWSGRNRST2'
c1cwsblurst(2)='$CWSBLURST2'
c1frcsoilmoistgrnrst(2)='$FRCSOILMOISTGRNRST2'
c1frcsoilmoistrivrst(2)='$FRCSOILMOISTRIVRST2'
c1frcsoilmoistmsrrst(2)='$FRCSOILMOISTMSRRST2'
c1frcsoilmoistnnbrst(2)='$FRCSOILMOISTNNBRST2'

c1yldout1strst(2)='$YLDOUT1STRST2'
c1cwdout1strst(2)='$CWDOUT1STRST2'
c1cwsout1strst(2)='$CWSOUT1STRST2'
c1regfdout1strst(2)='$REGFDOUT1STRST2'
c1hvsdoyout1strst(2)='$HVSDOYOUT1STRST2'
c1crpdayout1strst(2)='$CRPDAYOUT1STRST2'
c1yldout2ndrst(2)='$YLDOUT2NDRST2'
c1cwdout2ndrst(2)='$CWDOUT2NDRST2'
c1cwsout2ndrst(2)='$CWSOUT2NDRST2'
c1regfdout2ndrst(2)='$REGFDOUT2NDRST2'
c1hvsdoyout2ndrst(2)='$HVSDOYOUT2NDRST2'
c1crpdayout2ndrst(2)='$CRPDAYOUT2NDRST2'
c1cwsout1stgrnrst(2)='$CWSOUT1STGRNRST2'
c1cwsout1stblurst(2)='$CWSOUT1STBLURST2'
c1cwsout2ndgrnrst(2)='$CWSOUT2NDGRNRST2'
c1cwsout2ndblurst(2)='$CWSOUT2NDBLURST2'

c1evaprst(2)='$EVAPRST2'
c1qsrst(2)='$QSRST2'
c1qsbrst(2)='$QSBRST2'
c1qtotrst(2)='$QTOTRST2'
c1qbfrst(2)='$QBFRST2'
c1qrcrst(2)='$QRCRST2'
EOF
fi
...
c1rgwrst(3)='$GWRST3'
c1crpdayrst(3)='$CRPDAYRST3'
c1hunarst(3)='$HEATUNITRST3'
c1swurst(3)='$SWURST3'
c1swprst(3)='$SWPRST3'
c1regfwrst(3)='$REGFWRST3'
c1regflrst(3)='$REGFLRST3'
c1regfhrst(3)='$REGFHRST3'
c1regfnrst(3)='$REGFNRST3'
c1regfprst(3)='$REGFPRST3'
c1btrst(3)='$BTRST3'
c1rsdrst(3)='$RSDRST3'
c1outbrst(3)='$OUTBRST3'
c1cwdrst(3)='$CWDRST3'
c1cwsrst(3)='$CWSRST3'
c1cwsgrnrst(3)='$CWSGRNRST3'
c1cwsblurst(3)='$CWSBLURST3'
c1frcsoilmoistgrnrst(3)='$FRCSOILMOISTGRNRST3'
c1frcsoilmoistrivrst(3)='$FRCSOILMOISTRIVRST3'
c1frcsoilmoistmsrrst(3)='$FRCSOILMOISTMSRRST3'
c1frcsoilmoistnnbrst(3)='$FRCSOILMOISTNNBRST3'

c1yldout1strst(3)='$YLDOUT1STRST3'
c1cwdout1strst(3)='$CWDOUT1STRST3'
c1cwsout1strst(3)='$CWSOUT1STRST3'
c1regfdout1strst(3)='$REGFDOUT1STRST3'
c1hvsdoyout1strst(3)='$HVSDOYOUT1STRST3'
c1crpdayout1strst(3)='$CRPDAYOUT1STRST3'
c1yldout2ndrst(3)='$YLDOUT2NDRST3'
c1cwdout2ndrst(3)='$CWDOUT2NDRST3'
c1cwsout2ndrst(3)='$CWSOUT2NDRST3'
c1regfdout2ndrst(3)='$REGFDOUT2NDRST3'
c1hvsdoyout2ndrst(3)='$HVSDOYOUT2NDRST3'
c1crpdayout2ndrst(3)='$CRPDAYOUT2NDRST3'
c1cwsout1stgrnrst(3)='$CWSOUT1STGRNRST3'
c1cwsout1stblurst(3)='$CWSOUT1STBLURST3'
c1cwsout2ndgrnrst(3)='$CWSOUT2NDGRNRST3'
c1cwsout2ndblurst(3)='$CWSOUT2NDBLURST3'

c1evaprst(3)='$EVAPRST3'
c1qsrst(3)='$QSRST3'
c1qsbrst(3)='$QSBRST3'
c1qtotrst(3)='$QTOTRST3'
c1qbfrst(3)='$QBFRST3'
c1qrcrst(3)='$QRCRST3'
EOF
fi
...
c1rgwrst(4)='$GWRST4'
c1crpdayrst(4)='$CRPDAYRST4'
c1hunarst(4)='$HEATUNITRST4'
c1swurst(4)='$SWURST4'
c1swprst(4)='$SWPRST4'
c1regfwrst(4)='$REGFWRST4'
c1regflrst(4)='$REGFLRST4'
c1regfhrst(4)='$REGFHRST4'
c1regfnrst(4)='$REGFNRST4'
c1regfprst(4)='$REGFPRST4'
c1btrst(4)='$BTRST4'
c1rsdrst(4)='$RSDRST4'
c1outbrst(4)='$OUTBRST4'
c1cwdrst(4)='$CWDRST4'
c1cwsrst(4)='$CWSRST4'
c1cwsgrnrst(4)='$CWSGRNRST4'
c1cwsblurst(4)='$CWSBLURST4'
c1frcsoilmoistgrnrst(4)='$FRCSOILMOISTGRNRST4'
c1frcsoilmoistrivrst(4)='$FRCSOILMOISTRIVRST4'
c1frcsoilmoistmsrrst(4)='$FRCSOILMOISTMSRRST4'
c1frcsoilmoistnnbrst(4)='$FRCSOILMOISTNNBRST4'

c1yldout1strst(4)='$YLDOUT1STRST4'
c1cwdout1strst(4)='$CWDOUT1STRST4'
c1cwsout1strst(4)='$CWSOUT1STRST4'
c1regfdout1strst(4)='$REGFDOUT1STRST4'
c1hvsdoyout1strst(4)='$HVSDOYOUT1STRST4'
c1crpdayout1strst(4)='$CRPDAYOUT1STRST4'
c1yldout2ndrst(4)='$YLDOUT2NDRST4'
c1cwdout2ndrst(4)='$CWDOUT2NDRST4'
c1cwsout2ndrst(4)='$CWSOUT2NDRST4'
c1regfdout2ndrst(4)='$REGFDOUT2NDRST4'
c1hvsdoyout2ndrst(4)='$HVSDOYOUT2NDRST4'
c1crpdayout2ndrst(4)='$CRPDAYOUT2NDRST4'
c1cwsout1stgrnrst(4)='$CWSOUT1STGRNRST4'
c1cwsout1stblurst(4)='$CWSOUT1STBLURST4'
c1cwsout2ndgrnrst(4)='$CWSOUT2NDGRNRST4'
c1cwsout2ndblurst(4)='$CWSOUT2NDBLURST4'

c1evaprst(4)='$EVAPRST4'
c1qsrst(4)='$QSRST4'
c1qsbrst(4)='$QSBRST4'
c1qtotrst(4)='$QTOTRST4'
c1qbfrst(4)='$QBFRST4'
c1qrcrst(4)='$QRCRST4'
EOF
fi
...
# Start 
############################################################
$PROG $SETLND $SETRIV $SETHUM $SETCRP $SETRST > $LOGFILE 2>&1 &
# $PROG $SETLND $SETRIV $SETHUM $SETCRP $SETRST > $LOGFILE 2>&1

PID=$!
wait ${PID}

# echo "Simulation ${YEARRSTBGN}-${MONRSTBGN}-${DAYRSTBGN} has completed"
# echo "${12:5:8} has completed"

# if [ -f $SETLND  ]; then rm $SETLND;  fi
# if [ -f $SETRIV  ]; then rm $SETRIV;  fi
# if [ -f $SETHUM  ]; then rm $SETHUM;  fi
# if [ -f $SETCRP  ]; then rm $SETCRP;  fi
# if [ -f $SETRST  ]; then rm $SETRST;  fi
