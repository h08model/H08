...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c Main program to run coupled model with restart
c by 2023/06/01 Yuki Ishikawa (The University of Tokyo)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      implicit none
c parameter (array)
      integer           n0l              
...
c temporary
      ...
      real              r0tmp
      real              r1tmp(n0l)
      real              r2tmp(n0l,0:n0t)        !! (for restart; used for saving)
      ...
      character*128     s0rst            !! string "rst" (restart)
      data              s0ave/'ave'/
      data              s0sta/'sta'/ 
      data              s0spn/'spn'/
      data              s0sum/'sum'/ 
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c addtional params for restart
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c in (set of restart)
      integer           i0rstbgnflg                   !! restart start flag
      integer           i0yearrstbgn                  !! year of restart
      integer           i0monrstbgn                   !! month of restart
      integer           i0dayrstbgn                   !! day of restart
      integer           i0rstendflg                   !! restart end flag
      integer           i0yearrstend                  !! year of temporal termination for restart
...
c variables
      ...
      character*128     c1swprst(0:n0m)               !! Potential transpiration in latter half
      character*128     c1regfwrst(0:n0m)             !! Regulation factor in water
      character*128     c1regflrst(0:n0m)             !! Regulation factor in low temperature
      character*128     c1regfhrst(0:n0m)             !! Regulation factor in high temperature
      character*128     c1regfnrst(0:n0m)             !! Regulation factor in nitrogen
      character*128     c1regfprst(0:n0m)             !! Regulation factor in phosphorus
      character*128     c1btrst(0:n0m)                !! Total biomass
      character*128     c1rsdrst(0:n0m)               !! Residual 
      character*128     c1outbrst(0:n0m)              !! Out fo system
      character*128     c1cwdrst(0:n0m)               !! Crop water demand
      character*128     c1cwsrst(0:n0m)               !! Crop water supply
      character*128     c1cwsgrnrst(0:n0m)            !! Crop water supply from green water
      character*128     c1cwsblurst(0:n0m)            !! Crop water supply from blue water
      character*128     c1flgculrst(n0c)              !! Cultivation flag
      character*128     c1flgirgrst(n0c)              !! Irrigation flag
      character*128     c1targetrst(n0c)              !! Target ratio of irrigation
      character*128     c0supagrrst                   !! Agricultural water supply
      character*128     c0msrstorst                   !! Storage of medium sized reservoirs
      character*128     c0damoutrst                   !! Outflow from dam
      character*128     c0damstorst                   !! Storage of dam
      character*128     c0krlsrst                     !! Release coefficient
      character*128     c0frcsupagrrivrst             !! Fraction of agr. water supply from river
      character*128     c0frcsupagrrgwrst             !! Fraction of agr. water supply from RGW
      character*128     c0frcsupagrmsrrst             !! Fraction of agr. water supply from MSR
      character*128     c0frcsupagrnnbrst             !! Fraction of agr. water supply from NNBW
      character*128     c1frcsoilmoistgrnrst(0:n0m)   !! Fraction of green SM
      character*128     c1frcsoilmoistrivrst(0:n0m)   !! Fraction of river SM
      character*128     c1frcsoilmoistmsrrst(0:n0m)   !! Fraction of MSR SM
      character*128     c1frcsoilmoistnnbrst(0:n0m)   !! Fraction of NNBW SM
c     
      character*128     c1yldout1strst(0:n0m)         !! Crop yield
      character*128     c1cwdout1strst(0:n0m)         !! Crop water demand
      character*128     c1cwsout1strst(0:n0m)         !! Crop water supply
      character*128     c1cwsout1stgrnrst(0:n0m)      !! Crop water supply from green water
      character*128     c1cwsout1stblurst(0:n0m)      !! Crop water supply from blue water
      character*128     c1regfdout1strst(0:n0m)       !! Dominant regulation factor
      character*128     c1crpdayout1strst(0:n0m)      !! Cropping days
      character*128     c1hvsdoyout1strst(0:n0m)      !! Harvest day of the year
      character*128     c1yldout2ndrst(0:n0m)
      character*128     c1cwdout2ndrst(0:n0m)
      character*128     c1cwsout2ndrst(0:n0m)
      character*128     c1cwsout2ndgrnrst(0:n0m)
      character*128     c1cwsout2ndblurst(0:n0m)
      character*128     c1regfdout2ndrst(0:n0m)
      character*128     c1crpdayout2ndrst(0:n0m)
      character*128     c1hvsdoyout2ndrst(0:n0m)
c
      character*128     c0damdemrst                   !! Water demand for indivisual res.
      character*128     c0msroutrst                   !! Outflow from medium-sized res.
      character*128     c0supindrst                   !! Industrial water supply
      character*128     c0supdomrst                   !! Domestic water supply
      character*128     c0losagrrst                   !! Water loss from agr.
      character*128     c0rtfagrrst                   !! Return flow from agr.
      character*128     c0rtfindrst                   !! Return flow from ind.
      character*128     c0rtfdomrst                   !! Return flow from dom.
      character*128     c1evaprst(0:n0m)              !! Evapotranspiration
      character*128     c1qsrst(0:n0m)                !! Surface runoff
      character*128     c1qsbrst(0:n0m)               !! Subsurface runoff
      character*128     c1qtotrst(0:n0m)              !! Total runoff
      character*128     c1qbfrst(0:n0m)               !! Baseflow
      character*128     c1qrcrst(0:n0m)                !! Recharge
c local
      integer           i0monmin_dummy
      integer           i0daymin_dummy
c namelist
      character*128     c0setrst        !! setting file for restart
      namelist         /setrst/
     $     i0rstbgnflg,       i0rstendflg,
     ...
     $     c1regfwrst,        c1regflrst,        c1regfhrst,        
     $     c1regfnrst,        c1regfprst,        c1btrst,           
     $     c1rsdrst,          c1outbrst,         c1cwdrst,          
     $     c1cwsrst,          c1cwsgrnrst,       c1cwsblurst,
     $     c1frcsoilmoistgrnrst, c1frcsoilmoistrivrst,
     $     c1frcsoilmoistmsrrst, c1frcsoilmoistnnbrst,
     $     c1yldout1strst,    c1cwdout1strst,    c1cwsout1strst,
     $     c1cwsout1stgrnrst, c1cwsout1stblurst, c1regfdout1strst,
     $     c1crpdayout1strst, c1hvsdoyout1strst, c1yldout2ndrst,
     $     c1cwdout2ndrst,    c1cwsout2ndrst,    c1cwsout2ndgrnrst,
     $     c1cwsout2ndblurst, c1regfdout2ndrst,  c1crpdayout2ndrst,
     $     c1hvsdoyout2ndrst,
     $     c0damdemrst,       c0msroutrst,       c0supindrst,
     $     c0supdomrst,       c0losagrrst,       c0rtfagrrst,
     $     c0rtfindrst,       c0rtfdomrst,       c1evaprst,
     $     c1qsrst,           c1qsbrst,          c1qtotrst,
     $     c1qbfrst,          c1qrcrst
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c land
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
...
c      real              r2hvsdoy(n0l,0:n0m)!! hvst day of year (all)
      ...
      real              r1crpday(n0l)        !! cropping days (for restart)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      if(iargc().ne.5) then
        write(6, *)
     $    'USAGE: main c0setlnd c0setriv c0sethum c0setcrp c0setrst'
        stop
      end if
c      
...
c - read c0setrst
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      open(15,file=c0setrst)
      read(15,nml=setrst)
      close(15)
      write(*,*) 'main_restart: --- Read namelist -------------------'
      write(*,nml=setrst)
      if(i0rstbgnflg.eq.1.and.i0spnflg.eq.0)then
        write(*,*) 'SPNFLG should be set to 1 for restart'
        stop
      end if
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c Read fixed fields (fraction)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
     ...
     $         i0dayrstbgn,0,i0secint,r1tmp)
        ...
        do i0m=1,n0m
          call read_result(
     $         n0l,c1soiltemprst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
        ...
        do i0m=1,n0m
          call read_result(
     $         n0l,c1avgsurftrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
        ...
        do i0m=1,n0m
          call read_result(
     $         n0l,c1swerst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
        ...
        do i0m=1,n0m
          call read_result(
     $         n0l,c1rgwrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r3rgw(i0l,0,i0m)=r1tmp(i0l)
          end do
        end do
      else                         !! Read state variables from ini files
        do i0m=1,n0m
      ...
      write(*,*) 'main: --- Initialize state variables --------------'
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      if(i0rstbgnflg.eq.1)then     !! Read state variables from rst files
        call read_result(
     $         n0l,c0rivinfrst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1rivinf)
        call read_result(
     $         n0l,c0rivoutrst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1rivout)
        do i0l=1,n0l
          r2rivout(i0l,1)=r1rivout(i0l)
        end do
d       write(*,*) 'main: r2rivout      :',r2rivout(i0ldbg,1)
     ...
     $         i0dayrstbgn,0,i0secint,r1supagr)
      else                         !! Read state variables from ini files
        call read_binary(n0l,c0rivstoini,r1rivsto)
        call read_binary(n0l,c0rivstoini,r1rivsto_pr)
      end if
d      write(*,*) 'main: r1rivsto      :',r1rivsto(i0ldbg)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c Initialize state variables (hum)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
      if(i0rstbgnflg.eq.1)then     !! Read state variables from rst files
        call read_result(
     $         n0l,c0damoutrst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1damout)
        call read_result(
     $         n0l,c0damstorst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1damsto)
        call read_result(
     $         n0l,c0krlsrst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1krls)
        call read_result(
     $         n0l,c0msrstorst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1msrsto)
      else                         !! Read state variables from ini files
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      if(i0rstbgnflg.eq.1)then     !! Read state variables from rst files
        do i0m=1,n0m
          call read_result(
     $         n0l,c1crpdayrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2crpday(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1hunarst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2huna(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1swurst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2swu(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1swprst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2swp(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1regfwrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2regfw(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1regflrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2regfl(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1regfhrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2regfh(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1regfnrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2regfn(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1regfprst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2regfp(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1btrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
        ...
        do i0m=1,n0m
          call read_result(
     $         n0l,c1rsdrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
        ...
        do i0m=1,n0m
          call read_result(
     $         n0l,c1outbrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
        ...
        do i0m=1,n0m
          call read_result(
     $         n0l,c1cwdrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwd(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1cwsrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cws(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1cwsgrnrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwsgrn(i0l,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1cwsblurst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwsblu(i0l,i0m)=r1tmp(i0l)
          end do
        end do
      else                         !! Read state variables from ini files
        do i0m=1,n0m
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c Initialize state variables
c - flgcul, flgirg, target (only at the begining of the restart calculation)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      if(i0rstbgnflg.eq.1)then     !! Read state variables from rst files
        do i0c=1,n0c
          call read_result(
     $         n0l,c1flgculrst(i0c),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            i2flgcul(i0l,i0c)=int(r1tmp(i0l))
          end do
          call read_result(
     $         n0l,c1flgirgrst(i0c),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            i2flgirg(i0l,i0c)=int(r1tmp(i0l))
          end do
          call read_result(
     $         n0l,c1flgirgrst(i0c),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2target(i0l,i0c)=r1tmp(i0l)
          end do
        end do
      end if
      write(*,*) 'main: i2flgcul(1):   ',i2flgcul(i0ldbg,1)
      write(*,*) 'main: i2flgcul(2):   ',i2flgcul(i0ldbg,2)
      write(*,*) 'main: i2flgirg(1):   ',i2flgirg(i0ldbg,1)
      write(*,*) 'main: i2flgirg(2):   ',i2flgirg(i0ldbg,2)
      write(*,*) 'main: r2target(1):   ',r2target(i0ldbg,1)
      write(*,*) 'main: r2target(2):   ',r2target(i0ldbg,2)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c Initialize state variables
c - Yield (only at the begining of the restart calculation)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      if(i0rstbgnflg.eq.1)then     !! Read state variables from rst files
        do i0m=1,n0m
          call read_result(
     $         n0l,c1yldout1strst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2yldout1st(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1cwdout1strst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwdout1st(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1cwsout1strst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwsout1st(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1cwsout1stgrnrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwsout1stgrn(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1cwsout1stblurst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwsout1stblu(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1regfdout1strst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2regfdout1st(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1crpdayout1strst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2crpdayout1st(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1hvsdoyout1strst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2hvsdoyout1st(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1yldout2ndrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2yldout2nd(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1cwdout2ndrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwdout2nd(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1cwsout2ndrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwsout2nd(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1cwsout2ndgrnrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwsout2ndgrn(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1cwsout2ndblurst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2cwsout2ndblu(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1regfdout2ndrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2regfdout2nd(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1crpdayout2ndrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2crpdayout2nd(i0l,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1hvsdoyout2ndrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r2hvsdoyout2nd(i0l,i0m)=r1tmp(i0l)
          end do
        end do
      end if
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
      if(i0rstbgnflg.eq.1)then     !! Read state variables from rst files
        call read_result(
     $         n0l,c0frcsupagrrivrst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1frcsupagrriv)
        call read_result(
     $         n0l,c0frcsupagrrgwrst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1frcsupagrrgw)
        call read_result(
     $         n0l,c0frcsupagrmsrrst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1frcsupagrmsr)
        call read_result(
     $         n0l,c0frcsupagrnnbrst,i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1frcsupagrnnb)
        do i0m=1,n0m
          call read_result(
     $         n0l,c1frcsoilmoistgrnrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r3frcsoilmoistgrn(i0l,0,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1frcsoilmoistrivrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r3frcsoilmoistriv(i0l,0,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1frcsoilmoistmsrrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r3frcsoilmoistmsr(i0l,0,i0m)=r1tmp(i0l)
          end do
        end do
        do i0m=1,n0m
          call read_result(
     $         n0l,c1frcsoilmoistnnbrst(i0m),i0yearrstbgn,i0monrstbgn,
     $         i0dayrstbgn,0,i0secint,r1tmp)
          do i0l=1,n0l
            r3frcsoilmoistnnb(i0l,0,i0m)=r1tmp(i0l)
          end do
        end do
      else
        r1frcsupagrriv=0.0
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c Initialize (Substitute monthly/yearly values from previous calculation)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      if(i0rstbgnflg.eq.1)then
        call read_result(
     $       n0l,c0damdemrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2damdem(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0damdemrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2damdem(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0rivoutrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2rivout(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0rivoutrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2rivout(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0damoutrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2damout(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0damoutrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2damout(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0msroutrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2msrout(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0msroutrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2msrout(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0supagrrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2supagr(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0supagrrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2supagr(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0supindrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2supind(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0supindrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2supind(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0supdomrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2supdom(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0supdomrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2supdom(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0losagrrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2losagr(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0losagrrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2losagr(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0rtfagrrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2rtfagr(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0rtfagrrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2rtfagr(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0rtfindrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2rtfind(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0rtfindrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2rtfind(i0l,3)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0rtfdomrst,
     $       i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2rtfdom(i0l,2)=r1tmp(i0l)
        end do
        call read_result(
     $       n0l,c0rtfdomrst,
     $       i0yearrstbgn,0,0,0,i0secint,r1tmp)
        do i0l=1,n0l
            r2rtfdom(i0l,3)=r1tmp(i0l)
        end do
        do i0m=0,n0m
          call read_result(
     $         n0l,c1evaprst(i0m),
     $         i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3evap(i0l,2,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1evaprst(i0m),
     $         i0yearrstbgn,0,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3evap(i0l,3,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qsrst(i0m),
     $         i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qs(i0l,2,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qsrst(i0m),
     $         i0yearrstbgn,0,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qs(i0l,3,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qsbrst(i0m),
     $         i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qsb(i0l,2,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qsbrst(i0m),
     $         i0yearrstbgn,0,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qsb(i0l,3,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qtotrst(i0m),
     $         i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qtot(i0l,2,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qtotrst(i0m),
     $         i0yearrstbgn,0,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qtot(i0l,3,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qbfrst(i0m),
     $         i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qbf(i0l,2,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qbfrst(i0m),
     $         i0yearrstbgn,0,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qbf(i0l,3,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qrcrst(i0m),
     $         i0yearrstbgn,i0monrstbgn,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qrc(i0l,2,i0m)=r1tmp(i0l)
          end do
          call read_result(
     $         n0l,c1qrcrst(i0m),
     $         i0yearrstbgn,0,0,0,i0secint,r1tmp)
          do i0l=1,n0l
              r3qrc(i0l,3,i0m)=r1tmp(i0l)
          end do
        end do
      end if
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c
      ...
      else if(i0rstbgnflg.eq.1)then   !! Start year is updated for restart calculation
        if(i0monrstbgn.eq.12.and.i0dayrstbgn.eq.31)then
          i0yearmin_dummy=i0yearrstbgn+1
        else
          i0yearmin_dummy=i0yearrstbgn
        end if
...
c
      do i0year=i0yearmin_dummy,i0yearmax_dummy  !! Yearly loop
cvar start
        do i0m=1,n0m
          call read_result(
...
cvar end
c
c     !! Start month is updated for restart
        if(i0rstbgnflg.eq.1.and.
     $     i0year.eq.i0yearrstbgn)then
          if(i0dayrstbgn.eq.igetday(i0yearrstbgn,i0monrstbgn))then
            i0monmin_dummy=i0monrstbgn+1
          else
            i0monmin_dummy=i0monrstbgn
          end if
        else
          i0monmin_dummy=1
        end if
c
        do i0mon=i0monmin_dummy,12                    !! Monthly loop
c
c     !! Start day is updated for restart
          if(i0rstbgnflg.eq.1.and.
     $     i0year.eq.i0yearrstbgn.and.i0mon.eq.i0monrstbgn)then
            i0daymin_dummy=i0dayrstbgn+1
          else
            i0daymin_dummy=1
          end if
c
          do i0day=i0daymin_dummy,igetday(i0year,i0mon) !! Daily loop
            do i0sec=i0secint,n0secday,i0secint      !! Time-step loop
              write(*,*) '------------------------------'
...
c
     ...
     $               i0year,i0mon,i0day,n0secday,n0secday,
     $               s0ave)
                if(i0rstendflg.eq.1.and.i0spnflg.eq.1)then
                  if(i0year.eq.i0yearrstend.and.
     $               i0mon.eq.i0monrstend.and.
     $               i0day.eq.i0dayrstend.and.i0sec.eq.n0secday)then
                    call wrte_bints2(n0l,n0t,
     $                   r1damdem,       r2damdem,     c0damdemrst,
     $                   i0year,i0mon,i0day,n0secday,n0secday,
     $                   s0rst)
                  end if
                end if
...
c out (restart - lnd)
     ...
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3soiltemp(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,    r3soiltemp,  c1soiltemprst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3avgsurft(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,   r3avgsurft, c1avgsurftrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3swe(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,         r3swe,       c1swerst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3frcsoilmoistgrn(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,r3frcsoilmoistgrn,
     $                   c1frcsoilmoistgrnrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3frcsoilmoistriv(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,r3frcsoilmoistriv,
     $                   c1frcsoilmoistrivrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3frcsoilmoistmsr(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,r3frcsoilmoistmsr,
     $                   c1frcsoilmoistmsrrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3frcsoilmoistnnb(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,r3frcsoilmoistnnb,
     $                   c1frcsoilmoistnnbrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
c
c     !! for monthly/yearly aggregation
                    do i0l=1,n0l
                      r1tmp(i0l)=r3evap(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,   r3evap, c1evaprst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0rst,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3qs(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,   r3qs, c1qsrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0rst,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3qsb(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,   r3qsb, c1qsbrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0rst,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3qtot(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,   r3qtot, c1qtotrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0rst,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3qbf(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,   r3qbf, c1qbfrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0rst,n0m,i0m,r2arafrc,s0ave)
                    do i0l=1,n0l
                      r1tmp(i0l)=r3qrc(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,   r3qrc, c1qrcrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0rst,n0m,i0m,r2arafrc,s0ave)
d                   write(*,*) 'main: State variables (restart)'
d                   write(*,*) 'main: |-i0m:    ',i0m
d                   write(*,*) 'main: |-r1sm:   ',r1soilmoist(i0ldbg)
d                   write(*,*) 'main: |-r1st:   ',r1soiltemp(i0ldbg)
d                   write(*,*) 'main: |-r1ast:  ',r1avgsurft(i0ldbg)
d                   write(*,*) 'main: |-r1swe:  ',r1swe(i0ldbg)
                  end if
                end if
              end do                                 !! End the mosaic loop
c
              call wrte_bints2(n0l,n0t,
...
c
     ...
     $               *r2arafrc(i0l,i0m)/r2arafrc(i0l,i0m+5)
              ...
              if(r2arafrc(i0l,i0m+1).eq.0.0)then
                      r3rgw(i0l,0,i0m+1)=r3rgw(i0l,0,i0m+1)
     $               +min(0.0,r3rgw(i0l,0,i0m))
...
c return flow/loss
     ...
     $             i0year,i0mon,i0day,i0sec,i0secint,
     $             s0ave)
c out (restart - riv,dam)
              if(i0rstendflg.eq.1.and.i0spnflg.eq.1)then
                if(i0year.eq.i0yearrstend.and.
     $             i0mon.eq.i0monrstend.and.
     $             i0day.eq.i0dayrstend.and.i0sec.eq.n0secday)then
                  call wrte_bints2(n0l,n0t,
     $                 r1rivout,       r2rivout,     c0rivoutrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1rivinf,       r2tmp,     c0rivinfrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0sta)
                  call wrte_bints2(n0l,n0t,
     ...
     $                 s0sta)
                  call wrte_bints2(n0l,n0t,
     $                 r1damout,       r2damout,     c0damoutrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1damsto,       r2damsto,     c0damstorst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0sta)
                  call wrte_bints2(n0l,n0t,
     $                 r1krls,         r2tmp,       c0krlsrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0sta)
                  call wrte_bints2(n0l,n0t,
     $                 r1msrsto,       r2msrsto,     c0msrstorst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0sta)
                  call wrte_bints2(n0l,n0t,
     $                 r1supagr,       r2supagr,     c0supagrrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1frcsupagrriv, r2tmp, c0frcsupagrrivrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0sta)        
                  call wrte_bints2(n0l,n0t,
     $                 r1frcsupagrrgw, r2tmp, c0frcsupagrrgwrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0sta)
                  call wrte_bints2(n0l,n0t,
     $                 r1frcsupagrmsr, r2tmp, c0frcsupagrmsrrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0sta)
                  call wrte_bints2(n0l,n0t,
     $                 r1frcsupagrnnb, r2tmp, c0frcsupagrnnbrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0sta)
                  do i0m=1,n0m
                    do i0l=1,n0l
                      r1tmp(i0l)=r3rgw(i0l,0,i0m)
                    end do
                    call wrte_bints3(n0l,n0t,
     $                   r1tmp,          r3rgw,        c1rgwrst,
     $                   i0year,i0mon,i0day,i0sec,i0secint,
     $                   s0sta,n0m,i0m,r2arafrc,s0ave)
                  end do
c
c     !! for monthly/yearly aggregation 
                  call wrte_bints2(n0l,n0t,
     $                 r1msrout,       r2msrout,     c0msroutrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1supind,       r2supind,     c0supindrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1supdom,       r2supdom,     c0supdomrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1losagr,       r2losagr,     c0losagrrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1rtfagr,       r2rtfagr,     c0rtfagrrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1rtfind,       r2rtfind,     c0rtfindrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                  call wrte_bints2(n0l,n0t,
     $                 r1rtfdom,       r2rtfdom,     c0rtfdomrst,
     $                 i0year,i0mon,i0day,i0sec,i0secint,
     $                 s0rst)
                end if
              end if
c
c     !! Calculate the crop yield
              if(i0sec.eq.n0secday)then
...
c out (restart - crp)
     ...
     $                 i0day.eq.i0dayrstend.and.i0sec.eq.n0secday)then
                      call wrte_bints2(n0l,n0t,
     $                     r1crpday,   r2tmp,  c1crpdayrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1huna,     r2tmp,     c1hunarst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1swu,      r2tmp,     c1swurst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1swp,      r2tmp,     c1swprst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1regfw,    r2tmp,     c1regfwrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1regfl,    r2tmp,     c1regflrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1regfh,    r2tmp,     c1regfhrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1regfn,    r2tmp,     c1regfnrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1regfp,    r2tmp,     c1regfprst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1bt,       r2tmp,     c1btrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1rsd,      r2tmp,     c1rsdrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1outb,     r2tmp,     c1outbrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1cwd,      r2tmp,     c1cwdrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1cws,      r2tmp,     c1cwsrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1cwsgrn,   r2tmp,     c1cwsgrnrst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                      call wrte_bints2(n0l,n0t,
     $                     r1cwsblu,   r2tmp,     c1cwsblurst(i0m),
     $                     i0year,i0mon,i0day,i0sec,i0secint,
     $                     s0sta)
                    end if
                  end if
...
c out  (restart - yld)                 
     ...
     $                 i0day.eq.i0dayrstend.and.i0sec.eq.n0secday)then
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1yldout1strst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2cwdout1st(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1cwdout1strst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2cwsout1st(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1cwsout1strst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2cwsout1stgrn(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1cwsout1stgrnrst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2cwsout1stblu(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1cwsout1stblurst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2regfdout1st(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1regfdout1strst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2crpdayout1st(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1crpdayout1strst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2hvsdoyout1st(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1hvsdoyout1strst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1yldout2ndrst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2cwdout2nd(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1cwdout2ndrst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2cwsout2nd(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1cwsout2ndrst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2cwsout2ndgrn(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1cwsout2ndgrnrst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2cwsout2ndblu(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1cwsout2ndblurst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2regfdout2nd(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1regfdout2ndrst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2crpdayout2nd(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1crpdayout2ndrst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2hvsdoyout2nd(i0l,i0m)
                      ...
                      call wrte_bints2(n0l,n0t,
     $                     r1tmp,    r2tmp,   c1hvsdoyout2ndrst(i0m),
     $                     i0year,i0mon,i0day,n0secday,n0secday,
     $                     s0sta)
                    end if
                  end if
                end do !! i0m           (End of the mosaic loop)
c
                do i0l=1,n0l
...
c out (restart - flgcul & flgirg)
     ...
     $               i0day.eq.i0dayrstend.and.i0sec.eq.n0secday)then
                    do i0c=1,n0c
                      do i0l=1,n0l
                        r1tmp(i0l)=real(i2flgcul(i0l,i0c))
                      end do
                      call wrte_bints2(n0l,n0t,
     $                  r1tmp,     r2tmp,     c1flgculrst(i0c),
     $                  i0year,i0mon,i0day,i0sec,i0secint,
     $                  s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=real(i2flgirg(i0l,i0c))
                      end do
                      call wrte_bints2(n0l,n0t,
     $                  r1tmp,     r2tmp,     c1flgirgrst(i0c),
     $                  i0year,i0mon,i0day,i0sec,i0secint,
     $                  s0sta)
                      do i0l=1,n0l
                        r1tmp(i0l)=r2target(i0l,i0c)
                      end do
                      call wrte_bints2(n0l,n0t,
     $                  r1tmp,     r2tmp,     c1targetrst(i0c),
     $                  i0year,i0mon,i0day,i0sec,i0secint,
     $                  s0sta)
                    end do
                  end if
                  write(*,*) 'main: i2flgcul(1): ',i2flgcul(i0ldbg,1)
                  write(*,*) 'main: i2flgcul(2): ',i2flgcul(i0ldbg,2)
d                 write(*,*) 'main: i2flgirg(1): ',i2flgirg(i0ldbg,1)
d                 write(*,*) 'main: i2flgirg(2): ',i2flgirg(i0ldbg,2)
                end if
c
              end if
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
            end do   !! sec
c Stop the calculation when the date matches restarting time
            if(i0rstendflg.eq.1.and.i0spnflg.eq.1)then
              if(i0year.eq.i0yearrstend.and.
     $           i0mon.eq.i0monrstend.and.
     $           i0day.eq.i0dayrstend)then
                write(*,*) 'Program main is terminated for restart.'
                stop
              end if
            end if
          end do     !! day
