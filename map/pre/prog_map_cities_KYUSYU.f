...
c
      ...
      integer n0xquart          !! # of horizontal grid cells 0.25 min data
      integer n0yquart          !! # of vertical   grid cells 0.25 min data
      parameter (n0xthird=240)
      parameter (n0ythird=360)
      parameter (n0xone=180)
      parameter (n0yone=180)
      parameter (n0xquart=720)
      parameter (n0yquart=720)
c
      integer i0x
      integer i0y
      ...
      integer i0recmax
c in
      real r2third(n0xthird,n0ythird)  !! input in 1 km
      character*128 c0third
c out
      real r2one(n0xone,n0yone)  !! output in 1 arcmin
      character*128 c0one
c function
      real r0freq
c local
      real r2quart(n0xquart,n0yquart)
      real r1dat(16)
      real r0dat
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c argument
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      call getarg(1,c0third)
      call getarg(2,c0one)
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
