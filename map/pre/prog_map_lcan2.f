...
c
      ...
      data              s0cen/'center'/ 
c
      real,allocatable::r2bsnsiz(:,:)
      character*128     c0bsnsiz
      real              r0bsnsizthr
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
c get argument
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc 
      if(iargc().ne.24)then
        ...
        write(*,*) '            c0out'
        write(*,*) '            c0bsnsiz, r0bsnsizthr'
        write(*,*) 'you typed ',iargc(),' arguments. 24 required.'
        stop
      end if
c
      call getarg(1,c0tmp)
      ...
      call getarg(23,c0bsnsiz)
      call getarg(24,c0tmp)
      read(c0tmp,*) r0bsnsizthr
c
      allocate(r1tmp(n0l))
      allocate(i1l2x(n0l))
      allocate(i1l2y(n0l))
...
c new
      call read_binary(n0l,c0bsnsiz,r1tmp)
      call conv_r1tor2(n0l,n0x,n0y,i1l2x,i1l2y,r1tmp,r2bsnsiz)      
c
...
c
      ...
      else if(c0optlim.eq.'within'.or.c0optlim.eq.'conditionally')then
        continue        
      else
...
c
      do i0y=1,n0y                             !! x of destination
        do i0x=1,n0x                           !! y of destination
          ...
          if(c0optlim.eq.'conditionally')then
            if(r2bsnsiz(i0x,i0y).lt.r0bsnsizthr)then
              r0num=-9999
            end if
          end if
          i0sco=0
...
c
          ...
          if(r0num.eq.r0num2.or.r0num.eq.-9999)then
